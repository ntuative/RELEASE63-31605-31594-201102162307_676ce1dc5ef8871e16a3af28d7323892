package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1195:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1207:String = "_COLORIZE";
      
      protected static const const_1657:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1457:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc12_ != null)
         {
            var_379 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_59 = var_379.clone();
            var_11 = var_379.clone();
         ...
         if(_loc13_)
         {
            var_789 = _loc13_.blend;
            var_444 = _loc13_.var_2723;
            if(var_443 != _loc13_.background)
            {
      ...
      {
         var_443 = param1;
         var_230 = !!var_443 ? uint(var_230 | var_534) : uint(var_230 & 16777215);
         this.var_166 = this.var_166 || param1;
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      ...
      {
         var_805 = param1;
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_527,this,null));
      }
      
      public function set color(param1:uint) : void
      {
         var_534 = param1 & 4278190080;
         var_230 = !!var_443 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      ...
      {
         var_534 = param1 << 24;
         var_230 = !!var_443 ? uint(var_534 | var_230) : uint(16777215 & var_230);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      
      public function set blend(param1:Number) : void
      {
         var_789 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_969);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_513,this,null));
         }
      }
      ...
      {
         var_444 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            else
            {
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1162,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_20,var_16,var_11,null,this.var_652,this.properties,var_804.concat(),_id) as WindowController;
         _loc2_.var_444 = var_444;
         _loc2_.var_166 = this.var_166;
         _loc2_._debug = this._debug;
         _loc2_.var_365 = this.var_365.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_379 = var_379.clone();
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2686 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_505)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1104,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_779,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_194,this,null));
            }
         }
      }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_43:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1085;
                  if(testParamFlag(WindowParam.const_364))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_208))
                        {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_194:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_549,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_164))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_170,WindowParam.const_156))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc9_ = uint(var_20);
                        var_20 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_509))
                        {
               ...
               case WindowNotifyEvent.const_453:
                  var_16.invalidate(this,var_11.union(var_59),WindowRedrawFlag.const_433);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_986,this,null));
                     if(this._parent != null)
                     {
               ...
               case WindowNotifyEvent.const_404:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_620,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_248,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_513:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1023);
                  break;
               case WindowNotifyEvent.const_445:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1657) == -1)
                     {
                        _loc8_.style = var_81;
                     }
                  }
               ...
               case WindowNotifyEvent.const_527:
                  if(!(var_20 & 0))
                  {
                     if(!this.var_21)
                     {
                        ...
                        var_16.invalidate(this,var_11,WindowRedrawFlag.const_433);
                     }
                  }
                  else if(var_20 & 0)
                  {
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_990:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1577:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1632:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_787:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1175:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1024:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1102:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_368:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1162:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_691:
               _loc2_ = "null";
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_444);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_444);
      }
         ...
         if(this.var_166 && var_444 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1457,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1457,param3,param1)) : false;
            }
         }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_134,WindowParam.const_164);
         var _loc2_:* = !testParamFlag(WindowParam.const_131,WindowParam.const_156);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_350)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_388)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         if(_state == WindowState.const_522)
         {
            return true;
         }
         _state = WindowState.const_522;
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_404;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_681;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1099,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_673;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function focus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1102,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1103,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1194 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_368,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1194 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_691,this,param1));
         return param1;
      }
