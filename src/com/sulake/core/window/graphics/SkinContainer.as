package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_954:uint = 8;
      
      private static const const_1338:String = "skin";
      
      private static const const_1342:String = "bitmap";
      
      private static const const_1339:String = "fill";
      
      private static const const_1337:String = "text";
      
      private static const const_1341:String = "label";
      
      private static const const_1340:String = "shape";
      ...
      private var var_1886:Dictionary;
      
      private var var_2660:Dictionary;
      
      private var var_2659:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1886 = new Dictionary();
         this.var_2660 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1886,this.var_2660);
         this.var_2659 = new Dictionary();
         this.var_2658 = new Dictionary();
         StateCodeTable.fillTables(this.var_2659,this.var_2658);
         this.var_426 = new Dictionary();
         this.var_426[const_1338] = BitmapSkinRenderer;
         this.var_426[const_1342] = BitmapDataRenderer;
         this.var_426[const_1339] = FillSkinRenderer;
         this.var_426[const_1337] = TextSkinRenderer;
         this.var_426[const_1341] = LabelRenderer;
         this.var_426[const_1340] = ShapeSkinRenderer;
         this.var_426[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_426[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_316 == null)
         {
            var_316 = new Array();
            var_316.push(WindowState.const_67);
            var_316.push(WindowState.const_74);
            var_316.push(WindowState.const_87);
            var_316.push(WindowState.const_54);
            var_316.push(WindowState.const_86);
            var_316.push(WindowState.const_82);
            var_316.push(WindowState.const_99);
            var_316.push(WindowState.const_97);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2723 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1886[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_966[param1] = new Array(const_954);
         }
         this.var_966[param1][param2] = param3;
         if(this.var_967[param1] == null)
         {
            this.var_967[param1] = new Array(const_954);
         }
         this.var_967[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_966[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_195)
            {
               _loc4_ = _loc3_["null"];
            }
         }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_967[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_195)
