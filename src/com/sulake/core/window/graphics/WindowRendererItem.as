package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_603:uint = 0;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1441 = 4294967295;
         this.var_959 = 0;
         this.var_1867 = new ColorTransform();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc12_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_950) : uint(const_603);
         var _loc6_:Boolean = this.var_181.width > 0 && this.var_181.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_959))
            {
               _loc5_ = const_949;
            }
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_949)
               {
                  ...
                  if(this.var_625)
                  {
                     ...
                     _loc7_.draw(param1,this.var_100,this.var_100.rect,this.var_959,false);
                  ...
                  {
                     this.var_993.tx = param2.x;
                     this.var_993.ty = param2.y;
                     this.var_1867.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_100,this.var_993,this.var_1867,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = this.var_816.getSkinRendererByTypeAndStyle(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_195)
            {
               _loc2_ = this.var_816.getSkinRendererByTypeAndStyle(param1.type,WindowStyle.const_195);
            }
         }
         return _loc2_;
      }
      ...
      {
         return this.var_816.getTheActualState(param1.type,param1.style,param1.state) != this.var_1441;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_433:
               ...
               break;
            case WindowRedrawFlag.const_1023:
               this.var_959 = this.var_816.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_959 != this.var_1441)
               {
                  this.var_625 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_969:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_625 = true;
                  _loc4_ = true;
