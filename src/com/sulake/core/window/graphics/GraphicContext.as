package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1863:uint = 64;
      
      public static const const_1712:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_536:uint = 0;
      
      protected static var var_315:uint = 0;
       
      
      protected var var_203:DisplayObjectContainer;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_203.numChildren > 0)
               {
                  this.var_203.removeChildAt(0);
               }
            }
            this.var_203 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_187)
            {
               this.var_187 = new Shape();
               this.var_187.visible = false;
               this.var_187.cacheAsBitmap = true;
               super.addChild(this.var_187);
            }
            this.var_187.graphics.clear();
            this.var_187.graphics.beginFill(255);
            this.var_187.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_187.graphics.endFill();
            this.getDisplayObject().mask = this.var_187;
         }
         else if(this.var_187)
         {
            super.removeChild(this.var_187);
            this.var_187.graphics.clear();
            this.var_187 = null;
         ...
         if(this.var_802)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_315 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_802)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_315 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_203 == null)
         {
            this.var_203 = new Sprite();
            this.var_203.name = this.name + " - Child Container";
            this.var_203.mouseEnabled = false;
            addChild(this.var_203);
         }
         return this.var_203;
      }
      ...
      {
         return this.var_203 != null ? int(this.var_203.numChildren) : 0;
      }
