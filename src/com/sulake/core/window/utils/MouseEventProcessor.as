package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_80:WindowController;
      
      protected var var_163:IWindowRenderer;
      
      protected var var_136:IDesktopWindow;
      
      protected var var_795:IWindowContextStateListener;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_175;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_136 = param1.desktop;
         this.var_80 = param1.var_1222 as WindowController;
         this._lastClickTarget = param1.var_1220 as WindowController;
         this.var_163 = param1.renderer;
         this.var_795 = param1.var_1219;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_647.x || _loc3_.stageY != this.var_647.y)
            {
               ...
               _loc6_ = new Array();
               this.var_136.groupParameterFilteredChildrenUnderPoint(this.var_647,_loc6_,WindowParam.const_30);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_80 != this.var_136 && !this.var_80.disposed)
                  {
                     this.var_80.getGlobalPosition(_loc7_);
                     this.var_80.update(this.var_80,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_80,null,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                     this.var_80 = WindowController(this.var_136);
                  }
               }
            }
            while(--_loc4_ > -1)
            {
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  if(_loc3_.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(_loc5_ != this.var_80)
                     {
                        if(!this.var_80.disposed)
                        {
                           this.var_80.getGlobalPosition(_loc7_);
                           this.var_80.update(this.var_80,new WindowMouseEvent(WindowMouseEvent.const_25,this.var_80,_loc5_,_loc3_.stageX - _loc7_.x,_loc3_.stageY - _loc7_.y,_loc3_.stageX,_loc3_.stageY,_loc3_.altKey,_loc3_.ctrlKey,_loc3_.shiftKey,_loc3_.buttonDown,_loc3_.delta));
                        }
                        if(!_loc5_.disposed)
                        {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_80 && !this.var_80.disposed)
                     {
                        ...
                        {
                           this.var_795.mouseEventReceived(_loc3_.type,this.var_80);
                        }
                     }
                  }
                  ...
                  if(_loc3_.altKey)
                  {
                     if(this.var_80)
                     {
                        Logger.log("HOVER: " + this.var_80.name);
                     }
                  }
                  if(_loc5_ != this.var_136)
                  {
         ...
         param2.end();
         param1.desktop = this.var_136;
         param1.var_1222 = this.var_80;
         param1.var_1220 = this._lastClickTarget;
         param1.renderer = this.var_163;
         param1.var_1219 = this.var_795;
      }
