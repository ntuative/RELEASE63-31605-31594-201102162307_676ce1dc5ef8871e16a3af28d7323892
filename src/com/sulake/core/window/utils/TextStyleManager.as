package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_172:String = "regular";
      ...
      private static const const_1350:String = "/*";
      
      private static const const_1349:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_85[const_172],var_85[ITALIC],var_85[BOLD]];
            var_85.reset();
            var_85[const_172] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_523.indexOf(_loc4_.name) == -1)
            {
               var_523.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_604);
         if(countSubStrings(param1,const_605) != countSubStrings(param1,const_604))
         {
            throw new Error("Mismatching amount of \"" + const_605 + "\" versus \"" + const_604 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1350) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1349) + 2,_loc5_.length);
            }
