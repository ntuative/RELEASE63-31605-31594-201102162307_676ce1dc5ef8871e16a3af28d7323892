package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1124:String = "_EXCLUDE";
      
      public static const const_1887:String = "_INCLUDE";
      
      public static const const_1856:String = "_TEMP";
      
      private static const const_1322:String = "layout";
      
      private static const const_947:String = "window";
      
      private static const const_948:String = "variables";
      
      private static const const_946:String = "filters";
      
      private static const const_601:String = "name";
      
      private static const const_1323:String = "style";
      
      private static const const_600:String = "params";
      
      private static const const_1330:String = "tags";
      ...
      private static const const_1318:String = "visible";
      
      private static const const_1325:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_969:String = "blend";
      
      private static const const_1320:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1324:String = "treshold";
      
      private static const const_1321:String = "children";
      
      private static const const_1317:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1319:String = "height_min";
      
      private static const const_1329:String = "height_max";
      
      private static const const_602:String = "true";
      
      private static const const_154:String = "0";
      ...
      private static const const_1326:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1242:Dictionary;
      
      protected var var_1241:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1241 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1242,this.var_1241);
         this.var_998 = new Dictionary();
         this.var_1485 = new Dictionary();
         ParamCodeTable.fillTables(this.var_998,this.var_1485);
         this.var_1985 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1326,const_50);
         return param1.replace(const_1328,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1242)
            {
               delete this.var_1242[_loc1_];
            }
            for(_loc1_ in this.var_1241)
            {
               delete this.var_1241[_loc1_];
            }
            for(_loc1_ in this.var_998)
            {
               delete this.var_998[_loc1_];
            }
            for(_loc1_ in this.var_1485)
            {
               delete this.var_1485[_loc1_];
            }
            this.var_1985.dispose();
            this.var_1985 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1322)
         {
            _loc8_ = param1.child(const_948);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_946).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var caption:String = parent != null ? parent.caption : const_50;
         ...
         var id:int = 0;
         type = this.var_1242[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_601,variables,"")));
         style = uint(this.parseAttribute(xml,const_1323,variables,style));
         params = uint(this.parseAttribute(xml,const_600,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1330,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_154));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_154));
         rect.width = Number(this.parseAttribute(xml,const_1222,variables,const_154));
         rect.height = Number(this.parseAttribute(xml,const_1221,variables,const_154));
         visible = this.parseAttribute(xml,const_1318,variables,visible.toString()) == const_602;
         caption = unescape(String(this.parseAttribute(xml,const_1325,variables,caption)));
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_600).length() > 0)
         {
            list = xml.child(const_600).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_601,variables,"") as String;
               if(this.var_998[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_601)) + "\"!");
               }
         ...
         window = this.var_16.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_948)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1317,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1319,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1329,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_602;
         blend = Number(this.parseAttribute(xml,const_969,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1320,variables,window.clipping.toString()) == const_602;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1324,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_946).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = const_50;
         var _loc3_:String = this.var_1241[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1124) == -1)
                  {
