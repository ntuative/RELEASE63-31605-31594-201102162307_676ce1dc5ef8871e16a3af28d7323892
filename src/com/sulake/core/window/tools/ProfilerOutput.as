package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1250:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1249:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_141:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_141 = this.profiler;
         this._windowManager = param2;
         this.var_815 = param3;
         var _loc4_:ByteArray = new var_1250() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_141)
         {
            this.var_141.removeStopEventListener(this.refresh);
            this.var_141 = null;
         }
         if(!this.var_141 && param1)
         {
            this.var_141 = param1;
            this.var_141.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_863)
            {
               this.var_1503 = false;
               ILabelWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_141.getProfilerAgentsInArray();
         ...
         if(this.var_1503)
         {
            this._window.findChildByName("footer").caption = "Assets - Libraries: " + this.var_141.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_141.numBitmapAssetInstances + " / " + this.var_141.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_815.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_141.numTrackedBitmapDataInstances + " / " + this.var_141.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1249() as ByteArray;
