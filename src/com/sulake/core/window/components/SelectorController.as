package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      private var var_202:ISelectableWindow;
      
      protected var var_1974:Boolean = true;
      ...
      {
         return this.var_202 as ISelectableWindow;
      }
      ...
      public function setSelected(param1:ISelectableWindow) : void
      {
         if(param1 != null)
         {
            if(param1 != this.var_202)
            {
               if(this.var_202 != null)
               {
                  this.var_202.unselect();
               }
               this.var_202 = param1;
               this.var_202.select();
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_395,this,this.var_202));
               }
            }
         }
      }
