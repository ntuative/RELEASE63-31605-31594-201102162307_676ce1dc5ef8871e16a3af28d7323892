package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_1977:Boolean = false;
      ...
      protected var var_2787:Number = 0.0;
      
      protected var var_2786:Number = 0.0;
      ...
      protected var var_1976:int = 0;
      
      protected var var_1975:int = 0;
      
      protected var var_1237:Number;
      
      protected var var_1235:Number;
      
      protected var var_1234:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_166 = var_443 || !testParamFlag(WindowParam.const_32);
         this._container = var_16.create("_CONTAINER","",WindowType.const_381,WindowStyle.const_720,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_49,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_494,this.containerEventHandler);
         ...
         this.resizeOnItemUpdate = this.var_1236;
      }
      ...
      {
         return new Rectangle(this.var_649 * this.maxScrollH,this.var_650 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            this.var_650 = param1;
            this._container.y = -this.var_650 * this.maxScrollV;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_63);
            dispatchEvent(new WindowEvent(WindowEvent.const_418,this,null));
         }
      }
      ...
      {
         this.var_2787 = Math.max(param1,0);
      }
      
      public function set scrollStepV(param1:Number) : void
      {
         this.var_2786 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_509,param1);
            }
            else
            {
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_494,this.containerEventHandler);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_184:
               if(this.var_1234)
               {
                  this.var_1237 = this.var_1976 - _loc3_;
                  this.var_1235 = this.var_1975 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1237 != 0 && this.var_102 != 0)
                     {
                        this.scrollH += this.var_1237 / this.var_102;
                     }
                  }
                  else if(this.var_1235 != 0 && this.var_92 != 0)
                  {
                     this.scrollV += this.var_1235 / this.var_92;
                  }
                  this.var_1976 = _loc3_;
                  this.var_1975 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_175:
               if(this.var_1234)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1237,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1235);
                  }
                  this.var_1234 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_991 && !this.var_529 && this._container)
         {
            this.var_529 = true;
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_342,this._spacing,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1028);
         }
         if(this.var_991 != PropertyDefaults.const_1008)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_636,this.var_991,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1572);
         }
         if(this.var_439 != PropertyDefaults.const_1138)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_693,this.var_439,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1601);
         }
         if(this.var_1236 != PropertyDefaults.const_1180)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_746,this.var_1236,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1393);
         }
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_342:
                  ...
                  break;
               case PropertyDefaults.const_693:
