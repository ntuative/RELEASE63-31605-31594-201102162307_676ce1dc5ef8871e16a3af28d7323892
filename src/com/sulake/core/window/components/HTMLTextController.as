package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_821:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_669:String;
      
      private var var_1027:String = null;
      
      private var var_1554:StyleSheet = null;
      ...
      {
         this.var_669 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1027 == param2)
         {
            return;
         }
         param1.var_1027 = param2;
         param1.var_1554 = null;
         if(param1.var_1027 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1027);
            param1.var_1554 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_678.indexOf(param1) > -1)
         {
            this.var_669 = param1;
         }
      }
      ...
      {
         return this.var_669 == LinkTarget.const_31 ? defaultLinkTarget : this.var_669;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_19);
            _field.styleSheet = this.var_1554;
            refreshTextImage();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_669 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_783,this.var_669,PropertyStruct.const_51,true,PropertyDefaults.const_678));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1506);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_783)
            {
               this.var_669 = _loc2_.value as String;
               break;
            }
