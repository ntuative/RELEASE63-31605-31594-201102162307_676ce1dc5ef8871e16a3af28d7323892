package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1305:String = "_SELECTOR";
      
      private static const const_1306:String = "_CONTENT";
       
      
      protected var var_997:ITabSelectorWindow;
      
      protected var var_1983:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_997 = findChildByTag(const_1305) as ITabSelectorWindow;
            if(this.var_997 != null)
            {
               this.var_997.procedure = this.selectorEventProc;
            }
         }
         return this.var_997;
      }
      ...
      {
         if(this.var_1983 == null)
         {
            this.var_1983 = findChildByTag(const_1306) as IWindowContainer;
         }
      ...
      {
         return !!this.var_712 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_997.numSelectables;
      }
