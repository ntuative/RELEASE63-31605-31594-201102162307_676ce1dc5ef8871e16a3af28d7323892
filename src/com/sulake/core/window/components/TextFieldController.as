package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1232 = param1 == null ? "" : param1;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_456)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_712 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            var_16.handleError(WindowContext.const_376,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_609,false,PropertyStruct.const_37,true) : PropertyDefaults.const_1596);
         _loc1_.push(this.var_1238 != PropertyDefaults.const_1197 ? new PropertyStruct(PropertyDefaults.const_750,this.var_1238,PropertyStruct.const_37,true) : PropertyDefaults.const_1498);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1147 ? new PropertyStruct(PropertyDefaults.const_649,_field.selectable,PropertyStruct.const_37,true) : PropertyDefaults.const_1625);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_972 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_37,true) : PropertyDefaults.const_1563);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_750:
                  this.var_1238 = _loc2_.value as Boolean;
                  if(this.var_1238)
                  {
               ...
               case PropertyDefaults.const_649:
                  ...
                  break;
               case PropertyDefaults.const_609:
