package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1300:String = "_TITLE";
      
      private static const const_1301:String = "_HEADER";
      
      private static const const_1299:String = "_CONTENT";
      
      private static const const_1302:String = "_SCALER";
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1300) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1413 = findChildByTag(const_1301) as IHeaderWindow;
            if(!this.var_1413)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_179 = findChildByTag(const_1299) as IWindowContainer;
            if(!this.var_179)
            {
      ...
      {
         return findChildByTag(const_1302) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1207,_loc2_,false);
      ...
      {
         return this.content != null && this.var_990 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc4_:Boolean = testParamFlag(WindowParam.const_231);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            ...
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,_loc3_.top,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_242,0 - _loc3_.right,PropertyStruct.const_38,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_236,0 - _loc3_.bottom,PropertyStruct.const_38,_loc2_));
         }
         else
         {
