package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1225:String = "increment";
      
      private static const const_1226:String = "decrement";
      
      private static const const_897:String = "slider_track";
      
      private static const const_585:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_648:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_166 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_570;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_49,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_418,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_49,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_418,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_897) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_585) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_585:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_301)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_648;
                  }
                  else
                  {
                     this.scrollV -= this.var_648;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_43 || param1.type == WindowTouchEvent.const_456)
         {
            ...
            else if(param2.name == const_1226)
            {
               if(this.var_18)
               {
                  this.var_1028 = true;
            ...
            else if(param2.name == const_897)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_585).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
