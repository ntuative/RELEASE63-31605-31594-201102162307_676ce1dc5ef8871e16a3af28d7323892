package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1104:IItemListWindow;
      
      private var var_403:IScrollbarWindow;
      
      private var var_1724:Boolean = true;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_74))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_403)
         {
            this.var_403.removeEventListener(WindowEvent.const_303,this.scrollBarEventProc);
            this.var_403.removeEventListener(WindowEvent.const_224,this.scrollBarEventProc);
            this.var_403 = null;
         }
         if(this.var_1104)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1104)
         {
            this.var_1104 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_403)
         {
            ...
            if(this.var_403)
            {
               this.var_403.addEventListener(WindowEvent.const_303,this.scrollBarEventProc);
               this.var_403.addEventListener(WindowEvent.const_224,this.scrollBarEventProc);
            }
         }
         return this.var_403;
      }
