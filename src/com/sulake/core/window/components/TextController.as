package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1206:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_399,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_399 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_399,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_172);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_700 ? true : null;
         }
      ...
      {
         this.var_799 = param1;
         this._field.scrollH = this.var_799 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_799 * this.maxScrollH,this.var_531 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.antiAliasType != null ? this._field.antiAliasType != _loc2_.antiAliasType : this._field.antiAliasType != PropertyDefaults.const_995) ? new PropertyStruct(PropertyDefaults.const_800,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != AntiAliasType.NORMAL,PropertyDefaults.const_1078) : PropertyDefaults.const_1497);
         _loc1_.push(this._autoSize != PropertyDefaults.const_1048 ? new PropertyStruct(PropertyDefaults.const_761,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1193) : PropertyDefaults.const_1648);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_210,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1042 ? new PropertyStruct(PropertyDefaults.const_1105,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1057) : PropertyDefaults.const_1544);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_828) ? new PropertyStruct(PropertyDefaults.const_370,this._field.textColor,PropertyStruct.const_144,true) : PropertyDefaults.const_998);
         ...
         _loc1_.push(this.var_39.left != PropertyDefaults.const_834 ? new PropertyStruct(PropertyDefaults.const_265,this.var_39.left,PropertyStruct.const_38,true) : PropertyDefaults.const_464);
         _loc1_.push(this.var_39.top != PropertyDefaults.const_723 ? new PropertyStruct(PropertyDefaults.const_251,this.var_39.top,PropertyStruct.const_38,true) : PropertyDefaults.const_543);
         _loc1_.push(this.var_39.right != PropertyDefaults.const_795 ? new PropertyStruct(PropertyDefaults.const_242,this.var_39.right,PropertyStruct.const_38,true) : PropertyDefaults.const_567);
         _loc1_.push(this.var_39.bottom != PropertyDefaults.const_664 ? new PropertyStruct(PropertyDefaults.const_236,this.var_39.bottom,PropertyStruct.const_38,true) : PropertyDefaults.const_482);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1177 ? new PropertyStruct(PropertyDefaults.const_738,this._field.mouseWheelEnabled,PropertyStruct.const_37,true) : PropertyDefaults.const_1548);
