package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_606:Map = new Map();
      
      private static const const_328:Map = new Map();
      
      private static var var_1216:Boolean = false;
      ...
      {
         return const_606.getValue(param1) != null;
      }
      ...
      private static function init() : void
      {
         ...
         if(!var_1216)
         {
            ...
            for each(_loc3_ in _loc1_)
            {
               ...
               {
                  const_606.add(_loc3_.fontName,_loc3_);
               }
            }
            var_1216 = true;
         }
