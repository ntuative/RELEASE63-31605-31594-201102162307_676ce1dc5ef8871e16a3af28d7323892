package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1531:AssetTypeDeclaration;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_109 is BitmapDataAsset)
         {
            ...
            this.var_1340 = BitmapDataAsset(this.var_109).var_1340;
            this.var_1341 = BitmapDataAsset(this.var_109).var_1341;
            if(this._bitmap != null)
            {
               this.var_109 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1340 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1341 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
