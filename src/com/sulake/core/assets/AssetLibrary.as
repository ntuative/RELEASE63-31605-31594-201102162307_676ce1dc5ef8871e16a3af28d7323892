package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1030:String = "AssetLibraryReady";
      
      public static const const_623:String = "AssetLibraryLoaded";
      
      public static const const_1583:String = "AssetLibraryUnloaded";
      ...
      private var var_946:Boolean = true;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_505;
         this.var_421 = new Dictionary(false);
         this.var_506 = new Dictionary(false);
         this.var_945 = new Dictionary(false);
         this.var_157 = new Dictionary(false);
         var_944.push(this);
      }
      ...
      {
         if(this._file == param1.url && this.var_947)
         {
            if(!this.var_946 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_762,this.var_623);
            }
            this.var_946 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1030));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         this.var_947 = false;
         this._file = null;
         dispatchEvent(new Event(AssetLibrary.const_1583));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_506[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1059,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_994,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1118,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_989,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_506[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_506[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_28:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_157[struct.assetName] == null)
                  {
                     ++this.var_420;
                     this.var_419.push(struct.assetName);
                  }
                  this.var_157[struct.assetName] = asset;
               }
               else
               {
                  e = new AssetLoaderEvent(AssetLoaderEvent.const_46,e.status);
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_506[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_157[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      {
         return param1 < this.var_419.length ? this.getAssetByName(this.var_419[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_157)
         {
            if(this.var_157[_loc2_] == param1)
            {
               return this.var_419.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_157[param1] != null || (this.var_623 != null ? this.var_623[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_157[param1] == null;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_421.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_421[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(this.var_421[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_421)
         {
            _loc3_ = AssetTypeDeclaration(this.var_421[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_421)
         {
            _loc4_ = AssetTypeDeclaration(this.var_421[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_947 = true;
         dispatchEvent(new Event(AssetLibrary.const_623));
         dispatchEvent(new Event(AssetLibrary.const_1030));
         if(this.var_946)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_762.child("library");
         if(_loc2_ == null)
         {
