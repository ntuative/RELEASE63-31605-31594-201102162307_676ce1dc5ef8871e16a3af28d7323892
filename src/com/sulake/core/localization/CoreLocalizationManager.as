package com.sulake.core.localization
{
   ...
   public class CoreLocalizationManager extends Component implements ICoreLocalizationManager
   {
      ...
      {
         return this.getLocalizationDefinition(this.var_2404);
      }
      ...
      {
         var _loc3_:Localization = this.var_78[param1] as Localization;
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:Localization = this.var_78[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Localization(param1,param2);
            this.var_78[param1] = _loc3_;
         }
         else
         {
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_78)
         {
      ...
      {
         var _loc5_:Localization = this.var_78[param1];
         if(_loc5_ == null)
         {
            _loc5_ = new Localization(param1);
            this.var_78[param1] = _loc5_;
         }
      ...
      {
         return this.var_78[param1] as ILocalization;
      }
