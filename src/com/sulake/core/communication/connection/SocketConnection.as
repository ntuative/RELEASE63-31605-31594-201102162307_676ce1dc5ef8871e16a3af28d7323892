package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1569:int = 10000;
      ...
      private var var_1121:IEncryption;
      
      private var var_732:IProtocol;
      
      private var _id:String;
      
      private var var_1122:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this.var_1122 = new MessageClassManager();
         this.var_77 = new Socket();
         this.var_348 = new Timer(const_1569,1);
         this.var_348.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1122.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         if(this.var_491)
         {
            this.var_491.messageSent(String(_loc4_),_loc5_.toString());
         }
         if(this.var_1121 != null)
         {
            _loc3_ = this.var_1121.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      {
         this.var_1122.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + this.var_1121 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_732.getMessages(this.var_492,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               eventClasses = this.var_1122.getMessageEventClasses(id);
               events = new Array();
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_492.writeByte(this.var_77.readUnsignedByte());
         }
      }
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         _loc2_.text = "Socket Timeout (" + this.var_348.delay + " ms). Possible Firewall.";
