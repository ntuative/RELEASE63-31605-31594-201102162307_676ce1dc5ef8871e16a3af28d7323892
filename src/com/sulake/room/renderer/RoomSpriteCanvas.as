package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1698:int = 50;
      ...
      private var var_496:Point;
      
      private var var_254:BitmapDataCache;
      
      private var var_611:RoomObjectCache;
      
      private var var_495:Array;
      
      private var var_607:Array;
      
      private var var_1396:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2474:Number = -1.0E7;
      
      private var var_2476:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_255 = new Sprite();
         this.var_255.mouseEnabled = false;
         this.var_55 = new Sprite();
         this.var_55.name = "canvas";
         this.var_55.mouseEnabled = false;
         this.var_255.addChild(this.var_55);
         ...
         this.var_611 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_496.x -= param1 - this.var_609;
         this.var_609 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_496.y -= param1 - this.var_608;
         this.var_608 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_980 = true;
            if(this.var_132 != null && !this.var_255.contains(this.var_132))
            {
               this.var_255.addChild(this.var_132);
               this.var_55.mask = this.var_132;
            }
         }
         else if(!param1 && this.var_980)
         {
            ...
            if(this.var_132 != null && this.var_255.contains(this.var_132))
            {
               this.var_255.removeChild(this.var_132);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_255.numChildren > 0)
            {
               this.var_255.removeChildAt(0);
            }
            this.var_255 = null;
         }
         this.var_55 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_607.length)
            {
               this.cleanSprite(this.var_607[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_607 = [];
         }
      ...
      {
         this.var_611.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_737 != this.var_2478 || this._ht != this.var_2475)
         {
            _loc9_ = true;
         }
         if(this.var_55.x != this.var_609 || this.var_55.y != this.var_608)
         {
            this.var_55.x = this.var_609;
            this.var_55.y = this.var_608;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_495[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2478 = this.var_737;
         this.var_2475 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_611.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_611.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_609;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_608;
                  if(_loc19_ < this.var_737 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_609;
                     _loc17_.y = _loc20_ - this.var_608;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(this.var_607.length > 0)
         {
            _loc3_ = this.var_607.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_738 || this.var_738 == 0)
         {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_609;
         param2 -= this.var_608;
         this.var_496.x = param1;
         this.var_496.y = param2;
         if(this.var_1137 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1796;
         }
         this.var_1796 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1137;
         return this.var_1796;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_737 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1795,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_610.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_610.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2474 || param2 != this.var_2476)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_610.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_610.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_349.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1396.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1137 == 0)
         {
            this.checkMouseHits(this.var_496.x,this.var_496.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1137 = 0;
         ++this.var_1795;
      }
