package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_621:Number = 64;
      
      public static const const_1172:Number = 32;
      ...
      private var var_1506:Number = 1.0;
      
      private var var_1504:Number = 1.0;
      
      private var var_1505:Number = 1.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1505 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_161.x,this.var_161.y,this.var_161.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_74.x * this.var_385,this.var_74.y * this.var_384,this.var_74.z * this.var_383);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_231.x,this.var_231.y,this.var_231.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_385 != param1 * this.var_1506)
         {
            this.var_385 = param1 * this.var_1506;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_384 != param1 * this.var_1504)
         {
            this.var_384 = param1 * this.var_1504;
            ++this.var_142;
         }
      }
      ...
      {
         if(this.var_383 != param1 * this.var_1505)
         {
            this.var_383 = param1 * this.var_1505;
            ++this.var_142;
         }
      }
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_231.x;
         var _loc3_:Number = this.var_231.y;
         var _loc4_:Number = this.var_231.z;
         this.var_231.assign(param1);
         if(this.var_231.x != _loc2_ || this.var_231.y != _loc3_ || this.var_231.z != _loc4_)
         {
            ++this.var_142;
         }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_447 != null)
         {
            ...
            return this.var_447.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1006.assign(_loc22_);
         }
         else
         {
            this.var_1006.assign(_loc17_);
         }
         ++this.var_142;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_385;
         _loc2_.y *= this.var_384;
         _loc2_.z *= this.var_383;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1006);
         if(_loc3_ < this.var_2748 || _loc3_ > this.var_2749)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_384;
            _loc2_.z *= this.var_383;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1006);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_160,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_74.x * this.var_385,this.var_74.y * this.var_384,this.var_74.z * this.var_383);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_161;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_385,param2.y * this.var_384,param2.z * this.var_383);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_385,param3.y * this.var_384,param3.z * this.var_383);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_385,param4.y * this.var_384,param4.z * this.var_383);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1172;
         }
         else
         {
            this.scale = const_621;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_621;
      }
