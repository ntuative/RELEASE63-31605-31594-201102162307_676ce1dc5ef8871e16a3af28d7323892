package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_507:IKeyExchange;
      
      private var var_948:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2589:PseudoRandom;
      ...
      private const const_1658:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_624 = param1;
            this.var_50.initConnection(HabboConnectionType.const_228);
         }
      }
      ...
      {
         if(this.var_50 && this.var_158 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_220.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_158.getKey("use.sso.ticket") == "1";
         this.var_624 = this.var_158.getKey("sso.ticket",null);
         this.var_1854 = this.var_158.getKey("flash.client.url","");
         this.var_2588 = this.var_158.getKey("external.variables.txt","");
         if(this.var_220 == null)
         {
            this.var_220 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_50.mode = HabboConnectionType.const_121;
            if(this.var_624)
            {
               this.var_50.initConnection(HabboConnectionType.const_228);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_536,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_50.mode = HabboConnectionType.const_1186;
            }
         }
         this.var_50.initConnection(HabboConnectionType.const_228);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2589 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_50.mode)
         {
            case HabboConnectionType.const_121:
               _loc6_ = "";
               ...
               this.var_220.loadBannerImage(_loc7_ + "?token=" + this.var_1430,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1186:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1552:
               this.var_948 = this.generateRandomHexString(30);
               this.var_507 = new DiffieHellman(new BigInteger(this.var_158.getKey("connection.development.prime"),16),new BigInteger(this.var_158.getKey("connection.development.generator"),16));
               this.var_507.init(this.var_948);
               _loc8_ = this.var_507.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_507.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_507.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2589);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1854,this.var_2588));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1658,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_624 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_624);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_183);
         }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_234);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2590)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         this.var_507 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_507.init(_loc14_);
            _loc15_ = this.var_507.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_948 = _loc14_;
            }
