package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_536:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_140.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_129,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1658,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1658,"/");
         ...
         {
            dispatchEvent(new Event(const_536));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_120.removeEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
            this.var_120.removeEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
            this.var_120 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_120.addEventListener(SSOTicket.const_332,this.onParsedTicketSuccess);
         this.var_120.addEventListener(SSOTicket.const_298,this.onParsedTicketFailure);
      }
