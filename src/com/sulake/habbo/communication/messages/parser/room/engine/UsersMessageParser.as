   ...
   public class UsersMessageParser implements IMessageParser
   {
      ...
      public function parse(param1:IMessageDataWrapper) : Boolean
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            {
               _loc14_.userType = RoomObjectTypeEnum.const_1153;
               ...
               _loc14_.sex = UserMessageData.const_1101;
            }
            _loc3_++;
         }
         return true;
      ...
      private function resolveSex(param1:String) : String
      {
         ...
         {
            return UserMessageData.const_1637;
         }
         return UserMessageData.const_1101;
      }
