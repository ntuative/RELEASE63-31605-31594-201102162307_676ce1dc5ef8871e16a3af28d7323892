package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201102162302));
         this.var_180 = param5;
         this.var_108 = new Map();
         this.var_108.add(HabboHelpViewEnum.const_1584,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_193,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_479,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_300,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_257,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_390,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_755,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_237,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_108.add(HabboHelpViewEnum.const_1149,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_108.add(HabboHelpViewEnum.const_1188,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_108.add(HabboHelpViewEnum.const_763,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_472.length == 0 || param1 != this.var_334)
            {
               this.var_472.push(this.var_334);
            }
         }
         this.var_334 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1141:
               this.showUI(HabboHelpViewEnum.const_1188);
               break;
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_108.getValue(HabboHelpViewEnum.const_193) as IHelpViewController;
      ...
      {
         return this.var_108.getValue(this.var_334);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2228 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2227;
         this._window.width = _loc1_.width + this.var_2228;
      }
      ...
      {
         if(this.var_472.length > 0)
         {
            this.showUI(this.var_472.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_334 == HabboHelpViewEnum.const_193)
         {
            return;
         }
         if(this.var_568.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_568.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_568[1],this.var_568[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_568[0],this.var_568[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_334 == HabboHelpViewEnum.const_193 || this.var_472.length == 0)
         {
            return;
         }
         if(this.var_333 == null)
