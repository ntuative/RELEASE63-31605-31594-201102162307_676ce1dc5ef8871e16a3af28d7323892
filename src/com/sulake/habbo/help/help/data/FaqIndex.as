package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_760:FaqCategory;
      
      private var var_761:FaqCategory;
      ...
      {
         super();
         this.var_760 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_761 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_759 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_760.hasItem(param1))
         {
            this.var_760.getItem(param1).answerText = param2;
         }
         if(this.var_761.hasItem(param1))
         {
            this.var_761.getItem(param1).answerText = param2;
         }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_760.hasItem(param1))
         {
            return this.var_760.getItem(param1);
         }
         if(this.var_761.hasItem(param1))
         {
            return this.var_761.getItem(param1);
         }
         if(this.var_759.hasItem(param1))
         {
