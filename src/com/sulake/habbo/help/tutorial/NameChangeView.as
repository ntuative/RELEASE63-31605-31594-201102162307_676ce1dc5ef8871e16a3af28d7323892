package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1278:uint = 13232628;
      
      private static var var_1584:uint = 11129827;
      ...
      private var var_1034:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1585 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_676)
         {
            this.var_676 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_676)
            {
               return;
            }
            this._window.content.addChild(this.var_676);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_676.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_465;
         }
         this.showView(this.var_676);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_465);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         _loc5_.visible = true;
         this.var_1034 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1034.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1278;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_465 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_465 != _loc5_)
               {
                  this.var_1583 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_465);
               break;
