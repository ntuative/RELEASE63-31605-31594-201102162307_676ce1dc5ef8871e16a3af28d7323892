package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1245:String = "pixelbalance";
      
      private static const const_1252:String = "badges";
      
      private static const const_1248:String = "selectbadge";
      
      private static const const_1250:String = "inventory";
      
      private static const const_1247:String = "selectfurni";
      
      private static const const_1251:String = "credits";
      
      private static const const_1246:String = "friendlist";
      
      private static const const_1249:String = "pet_inventory";
      ...
      private var var_694:IHabboToolbar;
      ...
      private var var_469:HabboNotificationViewManager;
      
      private var var_208:HabboAlertDialogManager;
      
      private var var_693:ParkBusDialogManager;
      
      private var var_2189:Boolean;
      
      private var var_845:ClubGiftNotification;
      
      private var var_846:ClubEndingNotification;
      
      private var var_844:ClubPromoNotification;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_694)
         {
            this.var_694.release(new IIDHabboToolbar());
            this.var_694 = null;
         }
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1046.push(_loc8_);
         return this.var_1046.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1046.splice(0,1);
      ...
      {
         this.var_694 = IHabboToolbar(param2);
         this.var_694.events.addEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_69)
         {
            ...
            this.var_469 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_843["styles"],this.var_843["view"],this.var_694);
            ...
            registerUpdateReceiver(this.var_469,1);
            registerUpdateReceiver(this,2);
            this.var_392.events.addEventListener(BadgeImageReadyEvent.const_149,this.onBadgeImage);
            this.var_694.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1291[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_392);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1588,null);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_392.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1069,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1069,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1599,null);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_478.createAvatarImage(param2,AvatarScaleType.const_55);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1395,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_83:
               ...
               break;
            case CatalogPageMessageProductData.const_268:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1169)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1571,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1613)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_846 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_844 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_469.isSpaceAvailable() && this.var_1046.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_469.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1249:
               if(this._inventory != null && this._inventory.hasRoomSession)
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_140);
               }
               break;
            case const_1247:
               break;
      ...
      {
         if(param1 != null && this.var_469 != null)
         {
            this.var_469.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_693 == null)
         {
            this.var_693 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_693 != null)
         {
            this.var_693.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1125,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1125,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_478.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_55);
            if(_loc6_ != null)
            {
               _loc6_.setDirection(AvatarSetType.const_34,3);
               _loc4_ = _loc6_.getCroppedImage(AvatarSetType.const_48);
               _loc6_.dispose();
            }
         }
         else
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2189)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1066,null);
            this.var_2189 = true;
      ...
      {
         if(param2.type == WindowEvent.const_181 || param2.type == WindowEvent.const_868)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_845 && this.var_845.visible)
         {
            return;
         }
         this.var_845 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1066,_loc6_);
      }
   }
}
