package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_613:int = 70;
      
      public static const const_535:int = 4;
      
      private static const name_2:int = 0;
      
      private static const const_523:int = 1;
      
      private static const const_961:int = 2;
      
      private static const const_962:int = 3;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:IHabboToolbar, param6:HabboNotificationItem)
      {
         ...
         if(_loc8_ != null)
         {
            this.var_1927 = this._window.height - _loc8_.rectangle.bottom;
         }
         else
         {
            this.var_1927 = 15;
         }
         this.var_1929 = this._window.height;
         this.var_788 = 4;
         this.var_789 = 0;
         this._state = name_2;
         this.var_180 = param5;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_523:
               ...
               _loc2_ = Number(this.var_1218) / Number(this.var_435["time_fade_in"]);
               if(this.var_1218 > int(this.var_435["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_961:
               ...
               if(this.var_1473 > int(this.var_435["time_display"]) && !this.var_1928)
               {
                  this.startFadeOut();
               }
               break;
            case const_962:
               ...
               _loc3_ = 1 - Number(this.var_1217) / Number(this.var_435["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1217 > int(this.var_435["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1927;
         if(this._window.height < this.var_1929)
         {
            this._window.height = this.var_1929;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = this.var_180.orientation == "TOP" ? int(const_417) : 0;
         var _loc4_:int = this.var_180.orientation == "BOTTOM" ? int(_loc2_.height - const_417) : int(_loc2_.height);
         var _loc5_:int = this.var_180.orientation == "LEFT" ? int(const_417) : 0;
         var _loc6_:int = this.var_180.orientation == "RIGHT" ? int(_loc2_.width - const_417) : int(_loc2_.width);
         if(this.var_435["position_horizontal_follow_toolbar"] == "true" && (this.var_180.orientation != "TOP" && this.var_180.orientation != "BOTTOM"))
         {
            if(this.var_180.orientation == "LEFT")
            {
               this._window.x = _loc5_ + const_535;
            }
            else
            {
               this._window.x = _loc6_ - this._window.width - const_535;
            }
         }
         else if(this.var_435["position_horizontal"] == "left")
         {
            this._window.x = _loc5_ + const_535;
         }
         else
         ...
         if(this.var_435["position_vertical_follow_toolbar"] == "true" && (this.var_180.orientation != "RIGHT" && this.var_180.orientation != "LEFT"))
         {
            if(this.var_180.orientation == "TOP")
            {
               this._window.y = _loc3_ + this.var_788;
            }
            else
            {
               this._window.y = _loc4_ - this._window.height - this.var_788;
            }
         }
         else if(this.var_435["position_vertical"] == "top")
         {
            this._window.y = _loc3_ + this.var_788;
         }
         else
      ...
      private function adjustBlend(param1:Number) : void
      {
         ...
         this._window.blend = this.var_789;
      }
   }
}
