package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_544 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_544.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1347 = this.var_1029;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_48)
         {
            if((this.var_86 == 6 || this.var_86 == 0) && param2 == 7)
            {
               param2 = this.var_86;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1347);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_272.definition.geometryType);
         if(this.var_43 == null || _loc4_ != null && (this.var_43.width != _loc4_.width || this.var_43.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_272.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_615);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_544,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1347 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_615);
                  _loc20_ = this.var_86;
                  _loc21_ = 1;
                  switch(this.var_86)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_615);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_544,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_88)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_615);
                  _loc21_ = this.var_86;
                  _loc22_ = 1;
                  switch(this.var_86)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_501 = this.var_501 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_883);
         this.getCache().resetBodyPartCache(this.var_883);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1349 = this._structure.sortActions(this.var_314);
         ...
         {
            this.var_756 = this._structure.getCanvasOffsets(this.var_1349,this._scale,this.var_86);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1349)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_311)
               {
                  this.var_854 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1029 = _loc4_.id;
                     this.var_1565 = _loc4_.breed;
                     break;
                  }
               }
            }
