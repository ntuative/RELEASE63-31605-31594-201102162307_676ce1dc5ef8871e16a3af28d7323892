package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_591:String = "tab_boy";
      
      private const const_590:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_65.controller.gender)
         {
            case FigureData.const_78:
               activateTab(this.const_591);
               inactivateTab(this.const_590);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_590);
               inactivateTab(this.const_591);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_591:
                  var_65.controller.gender = FigureData.const_78;
