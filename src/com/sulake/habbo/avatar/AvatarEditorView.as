package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1221:IWindowContainer;
      
      public static var var_1476:IWindowContainer;
      
      public static var var_1932:int = 6710886;
      ...
      private var var_486:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1083 = [];
         this.var_1338 = [AvatarEditorFigureCategory.const_815,AvatarEditorFigureCategory.const_48,AvatarEditorFigureCategory.const_245,AvatarEditorFigureCategory.const_668,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_103];
         super();
         ...
         if(var_1221 == null)
         {
            ...
            var_1221 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1476 == null)
         {
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1.length != this.var_1083.length)
         {
            return false;
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2305 = this.canChangeOutfit();
            this.var_400.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_486 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_486.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_486.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1083.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_486.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_486.numSelectables)
               {
                  this.var_486.getSelectableAt(_loc6_).x = this.var_486.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      public function update() : void
      {
         ...
         {
            _loc3_.visible = this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_39) && this._controller.isWardrobeAllowed();
         }
         var _loc4_:String = "null";
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_39) && (this.var_1695 == AvatarEditorSideCategory.const_103 || this.var_2306))
         {
      ...
      {
         if(this.var_1695 == AvatarEditorSideCategory.const_103)
         {
            this.var_2306 = false;
            this.setSideContent(AvatarEditorSideCategory.const_722);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_722:
               break;
            case AvatarEditorSideCategory.const_455:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_455);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_334 = param1;
         this.var_486.setSelected(this.var_486.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_485)
         {
            ...
            this.var_485 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_485.procedure = this.stripClubDialogEventProc;
            this.var_485.center();
         }
         else
         {
