package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1268:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1267:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1063:AvatarEditorHandler;
      ...
      private var var_863:IFigureData;
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_186)
         {
            ...
            this.var_571["null"] = new FigureData(this);
            this.var_571["null"] = new FigureData(this);
            _loc2_ = this.var_571["null"];
            _loc3_ = this.var_571["null"];
            _loc2_.loadAvatarData(const_1268,FigureData.const_78);
            _loc3_.loadAvatarData(const_1267,FigureData.FEMALE);
            this.var_95 = new Map();
            this.var_477 = new Map();
            this.var_95.add(AvatarEditorFigureCategory.const_815,new BodyModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_48,new HeadModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_245,new TorsoModel(this));
            this.var_95.add(AvatarEditorFigureCategory.const_668,new LegsModel(this));
            ...
            this.var_477.add(AvatarEditorSideCategory.const_103,new WardrobeModel(this));
            this.var_477.add(AvatarEditorSideCategory.const_455,new ClubPromoModel(this));
            this.var_186 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_571[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_863.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_863.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_815);
         }
      ...
      {
         this.var_863 = this.var_478.getFigureData(AvatarType.const_122);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1063 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_571[this.var_813];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1547)
               {
                  _loc23_ = true;
               }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_477.getValue(AvatarEditorSideCategory.const_103);
      }
