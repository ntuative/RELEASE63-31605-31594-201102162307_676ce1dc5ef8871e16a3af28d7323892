package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1842:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1842 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2580 = parseInt(param1.@precedence);
         this.var_2581 = String(param1.@activepartset);
         this.var_2575 = String(param1.@assetpartdefinition);
         this.var_2576 = String(param1.@lay);
         this.var_662 = String(param1.@geometrytype);
         this.var_2412 = Boolean(parseInt(param1.@main));
         this.var_2577 = Boolean(parseInt(param1.@var_1120));
         this.var_2578 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2579 = _loc6_;
            }
            else
            {
               this.var_1842[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_756.add(param1,new Map());
         }
         var _loc4_:Map = this.var_756.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_756.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1842[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2579;
         }
         return _loc2_;
      }
