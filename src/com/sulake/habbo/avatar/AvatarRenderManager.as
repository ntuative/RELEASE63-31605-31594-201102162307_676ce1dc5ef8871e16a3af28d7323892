package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1925:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_641 = RenderMode.const_1565;
         ...
         this.var_101.add(AvatarType.const_122,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_311.init();
         this.var_787.init();
         _loc2_ = this.var_101.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_101.getValue(AvatarType.const_122) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               _loc5_.addEventListener(AvatarStructureDownload.const_1096,this.onFigureDataDownloadDone);
      ...
      private function checkIfReady() : void
      {
         if(!this.var_947)
         {
            if(this.var_2712 && this.var_2713 && this.var_2711)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_101.getValue(AvatarType.const_122) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1925)
         {
            this.var_1925 = new AvatarFigureContainer(this.const_1993);
         }
         this.var_227.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1925,param2);
      }
      ...
      {
         var _loc3_:AvatarStructure = this.var_101.getValue(AvatarType.const_122) as AvatarStructure;
