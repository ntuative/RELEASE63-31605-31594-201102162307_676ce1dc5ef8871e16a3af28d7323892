package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1662:int = 60000;
       
      
      private var _structure:AvatarStructure;
      
      private var var_1475:IAvatarImage;
      ...
      private var var_2069:ByteArray;
      
      private var var_2070:ImageData;
      
      private var var_974:PaletteMap;
      ...
      public function setGeometryType(param1:String) : void
      {
         ...
         if(this.var_662 == GeometryType.const_1027 && param1 == GeometryType.const_1095 || this.var_662 == GeometryType.const_1095 && param1 == GeometryType.const_1027)
         {
            this.var_662 = param1;
            this.var_83 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
            ...
            if(this.var_321.definition.isAnimation)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     ...
                     if(_loc14_.type == AnimationLayerData.const_631)
                     {
                        if(_loc14_.action != null)
                        {
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1475.getFigure(),_loc5_,this.var_662,_loc3_,_loc6_,_loc7_);
         ...
         if(this.var_409 == null)
         {
            ...
            this.var_409 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_321);
            if(this.var_409 == null)
            {
               return null;
            }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_83)
         {
            this.var_83 = this._structure.getCanvas(this._scale,this.var_662);
            if(!this.var_83)
            {
               return null;
            }
            this.var_2068 = new Point(0,this.var_83.height - int(this.var_83.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1518[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_784 || _loc10_ == AvatarAction.const_384;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1262 = this.var_103.bodyPartId;
               this.var_169 = this.var_103.partType;
               this.var_1530 = this.var_103.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_103.flippedPartType != this.var_169)
                     {
                        this.var_169 = this.var_103.flippedPartType;
                     }
                  }
               }
               this.var_1263 = this._scale + "_" + this.var_103.action.assetPartDefinition + "_" + this.var_169 + "_" + this.var_1530 + "_" + _loc5_ + "_" + this._frame;
               this.var_388 = this._assets.getAssetByName(this.var_1263) as BitmapDataAsset;
               if(this.var_388 == null)
               {
                  this.var_1263 = this._scale + "_std_" + this.var_169 + "_" + this.var_1530 + "_" + _loc5_ + "_0";
                  this.var_388 = this._assets.getAssetByName(this.var_1263) as BitmapDataAsset;
               }
               if(!(!this.var_388 || !this.var_388.content))
               {
                  ...
                  {
                     this.var_974 = this._structure.renderManager.paletteManager.getPalette(this.var_103.paletteMapId);
                     if(this.var_974 != null)
                     {
                        this.var_819 = this.var_388.content as BitmapData;
                        this.var_168 = new BitmapData(this.var_819.width,this.var_819.height);
                        this.var_2069 = this.var_974.colorize(this.var_819.getPixels(this.var_819.rect));
                        this.var_168.setPixels(this.var_168.rect,this.var_2069);
                     }
                     else
                     {
                        this.var_168 = (this.var_388.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1262 == AvatarBodyPartType.const_245 || this.var_1262 == AvatarBodyPartType.const_1541 || this.var_1262 == AvatarBodyPartType.const_1616) && this.var_103.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_168.colorTransform(this.var_168.rect,this.var_103.color.colorTransform);
                  }
                  if(this.var_103.isBlendable)
                  {
                     this.var_168.colorTransform(this.var_168.rect,this.var_103.blendTransform);
                  }
                  this.var_818 = this.var_388.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_55)
                     {
                  ...
                  this.var_2070 = new ImageData(this.var_168,this.var_818,_loc7_);
                  this.var_817.push(this.var_2070);
               }
            }
            _loc8_--;
         }
         ...
         var _loc13_:ImageData = this.createUnionImage(this.var_817,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2068.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_55)
            {
         ...
         _loc8_ = this.var_817.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_817.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }
