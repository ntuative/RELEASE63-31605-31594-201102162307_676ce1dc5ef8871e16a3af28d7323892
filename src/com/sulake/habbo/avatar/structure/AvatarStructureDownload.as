package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1096:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2268:IStructureData;
      
      private var var_1665:XML;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1665 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2268.appendXML(this.var_1665);
         dispatchEvent(new Event(AvatarStructureDownload.const_1096));
      }
   }
}
