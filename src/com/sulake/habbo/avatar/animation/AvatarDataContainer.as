package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1540:Number = 1.0;
      ...
      {
         super();
         this.var_1690 = parseInt(param1.@ink);
         ...
         this.var_1867 = new ColorTransform(this.var_1539,this.var_1540,this.var_1538,this._alphaMultiplier);
         this.var_1080 = this.generatePaletteMapForGrayscale(this.var_2300,this.var_2301);
      }
      ...
      {
         return this.var_1080.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1080.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1080.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1080.getValue("alphas") as Array;
      }
