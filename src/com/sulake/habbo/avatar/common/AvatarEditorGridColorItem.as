package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_871:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_619.width,this.var_619.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_619,this.var_619.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_942.width,this.var_942.height,true,0);
            _loc5_ = this.var_942.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_871.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_872.width,this.var_872.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_872,this.var_872.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
