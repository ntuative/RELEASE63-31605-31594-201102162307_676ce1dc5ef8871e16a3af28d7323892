package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1279:String = "Default";
      
      private static const const_1280:int = 2;
      
      private static const const_1281:String = AvatarSetType.const_34;
      ...
      protected var var_272:IActiveActionData;
      
      protected var var_742:Boolean;
      ...
      protected var var_544:AvatarFigureContainer;
      ...
      private var var_883:IActiveActionData;
      ...
      protected var var_1240:Boolean = false;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1281,const_1280);
         this.var_314 = new Array();
         this.var_883 = new ActiveActionData(AvatarAction.const_375);
         this.var_883.definition = this._structure.getActionDefinition(const_1279);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_544,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1707;
         if(param2 < AvatarDirectionAngle.const_1016)
         {
         ...
         if(param1 == AvatarSetType.const_48 || param1 == AvatarSetType.const_34)
         {
            if(param1 == AvatarSetType.const_48 && this.isHeadTurnPreventedByAction())
            {
               param2 = this.var_86;
            }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_615,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_257.length == 1 && this.var_86 == this.var_1982)
         {
            return this.var_86 + this.var_501 + this.var_615 % 4;
         }
         if(this.var_257.length == 2)
         {
            for each(_loc1_ in this.var_257)
            {
               ...
               {
                  return this.var_86 + this.var_501 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_615 % 11;
                  return this.var_86 + "_" + this.var_1982 + this.var_501 + _loc2_;
               }
            }
         }
         return null;
      ...
      private function getBodyParts(param1:String, param2:String, param3:int) : Array
      {
         if(param3 != this.var_2511 || param2 != this.var_2512 || param1 != this.var_2513)
         {
            ...
            this.var_1818 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc5_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_272.definition.geometryType);
         if(_loc5_ == null)
         {
            return null;
         }
         if(this.var_1240 || this.var_43 == null || (this.var_43.width != _loc5_.width || this.var_43.height != _loc5_.height))
         {
            if(this.var_43 != null && !this.var_1240)
            {
               this.var_43.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_272.definition.geometryType,this.var_86);
         this.var_43.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_615);
         ...
         if(this.var_532 != null)
         {
            if(this.var_532.paletteIsGrayscale)
            {
               ...
               this.var_43 = _loc13_;
               this.var_43.paletteMap(this.var_43,this.var_43.rect,new Point(0,0),this.var_532.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_272.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_272.definition.geometryType,this.var_86);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_615);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_314.push(new ActiveActionData(param1,param2,this.var_615));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_272 = this.var_883;
         this.var_272.definition = this.var_883.definition;
         this.resetBodyPartCache(this.var_883);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_501 = "";
         this.var_257 = this._structure.sortActions(this.var_314);
         if(this.var_257 == null)
         {
            this.var_756 = new Array(0,0,0);
            if(this.var_1409 != "")
            {
               _loc1_ = true;
               this.var_1409 = "";
         ...
         {
            this.var_756 = this._structure.getCanvasOffsets(this.var_257,this._scale,this.var_86);
            for each(_loc4_ in this.var_257)
            {
               this.var_501 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_286)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1410 != _loc5_)
                  {
                     _loc2_ = true;
                  }
            ...
            if(this.var_1409 != this.var_501)
            {
               _loc1_ = true;
               this.var_1409 = this.var_501;
            }
         }
         this.var_1348 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_257)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_854 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_193 = this.var_193.concat(_loc2_.spriteData);
               ...
               if(_loc1_.actionType == AvatarAction.const_311 || _loc1_.actionType == AvatarAction.const_267 || _loc1_.actionType == AvatarAction.const_384)
               {
                  this.var_854 = true;
               }
            }
