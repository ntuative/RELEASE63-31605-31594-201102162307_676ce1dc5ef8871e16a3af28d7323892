package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         if(_loc4_)
         {
            this.var_1042 = _loc4_.content as BitmapData;
         }
      ...
      {
         if(this.var_409 && this.var_1042)
         {
            this.var_409.bitmap = new BitmapData(this.var_409.width,this.var_409.height,true,16777215);
            this.var_409.bitmap.copyPixels(this.var_1042,this.var_1042.rect,new Point(0,this.var_409.height - this.var_1042.height - 8));
