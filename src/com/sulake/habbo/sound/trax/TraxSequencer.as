package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound
   {
      ...
      private static const const_1333:uint = 88200;
      ...
      private var var_1445:Sound;
      
      private var _soundChannel:SoundChannel;
      
      private var var_1877:TraxData;
      ...
      {
         this.var_1878 = uint(const_270 / 44.1);
         super();
         this._events = param4;
         this.var_2327 = param1;
         this.var_481 = 1;
         this.var_1445 = new Sound();
      ...
      {
         this.var_223 = uint(param1 * 44100);
      }
      ...
      public function play() : Boolean
      {
         ...
         this.var_1446 = false;
         this.var_1445.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = this.var_1445.play();
         return true;
      }
      ...
      public function stop() : Boolean
      {
         ...
         this.var_1445.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this._soundChannel = null;
         return true;
      }
      ...
      private function prepareSequence() : Boolean
      {
         ...
         var _loc11_:int = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1877.channels.length)
         {
            _loc2_ = new Map();
            _loc3_ = this.var_1877.channels[_loc1_] as TraxChannel;
            _loc4_ = 0;
            _loc5_ = 0;
            _loc6_ = 0;
            while(_loc6_ < _loc3_.itemCount)
            {
               ...
               _loc8_ = this.var_1879.getValue(_loc7_) as TraxSample;
               if(_loc8_ == null)
               {
      ...
      private function onSampleData(param1:SampleDataEvent) : void
      {
         ...
         var _loc4_:* = [];
         var _loc5_:* = null;
         var _loc6_:int = this.var_772.length;
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_.push(this.var_772[_loc7_].getKeys());
            _loc12_ = 0;
            ...
            _loc13_ = this.var_772[_loc7_].getWithIndex(_loc12_);
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc17_ = const_270;
            if(this._length - this.var_223 < _loc17_)
            {
               _loc17_ = this._length - this.var_223;
            }
            _loc18_ = 0;
            while(_loc18_ < _loc17_)
            {
               ...
               if(_loc18_ < _loc17_)
               {
                  if(_loc16_ < this.var_772[_loc7_].length - 1)
                  {
                     _loc21_ = this.var_772[_loc7_].getWithIndex(++_loc16_);
                     if(_loc21_.id == 0)
                     {
                        _loc5_ = null;
                     }
         ...
         if(this._length - this.var_223 < _loc9_)
         {
            _loc9_ = this._length - this.var_223;
            if(_loc9_ < 0)
            {
               _loc9_ = 0;
            }
         ...
         this.var_223 += const_270;
         if(this._soundChannel != null)
         {
            this.var_1878 = param1.position / 44.1 - this._soundChannel.position;
         }
         if(this.var_223 > this._length + this.var_1878 * 44.1)
         {
            this.var_1446 = true;
      ...
      {
         this.stop();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.const_656,this.var_2327));
      }
   }
}
