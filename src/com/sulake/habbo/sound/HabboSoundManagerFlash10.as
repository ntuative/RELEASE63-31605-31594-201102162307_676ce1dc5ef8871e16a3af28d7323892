package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_481:Number = 1.0;
      ...
      private var var_869:TraxSequencer;
      
      private var var_579:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_1182,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_867.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_1586:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1636:
                  _loc3_ = "sound_console_new_message";
                  break;
               case HabboSoundTypesEnum.const_1406:
                  _loc3_ = "sound_message_sent";
                  break;
               case HabboSoundTypesEnum.const_983:
                  _loc3_ = "sound_catalogue_pixels";
                  break;
               case HabboSoundTypesEnum.const_1142:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1416:
            ...
            this.var_867.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_481;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_578.add(_loc4_,param1);
      }
      ...
      {
         if(this.var_183 == null || this._connection == null || this._roomEngine == null || this.var_579 != null)
         {
            return;
         }
         this.var_579 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_578.getValue(_loc2_);
         ...
         this.var_578.remove(_loc2_);
         this.var_706.add(_loc3_,_loc6_);
         if(this.var_578.length == 0 && this.var_705 != -1)
         {
            this.var_869.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1182,this.var_705));
            this.var_705 = -1;
            this.var_869 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_579.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1452,this.var_705));
         this.var_705 = -1;
         this.var_869 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_481 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_481 * 100)));
         }
      }
      ...
      {
         this.var_481 = param1;
         this.var_579.updateVolume(this.var_481);
      ...
      private function setHabboToolbarIconState(param1:Boolean) : void
      {
         ...
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.SOUNDS);
