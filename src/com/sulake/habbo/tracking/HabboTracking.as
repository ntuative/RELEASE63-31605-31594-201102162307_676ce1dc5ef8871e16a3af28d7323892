package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_955:uint = 11;
      ...
      private var var_199:IHabboFriendList;
      
      private var var_1187:IHabboWindowManager;
      
      private var var_180:IHabboToolbar;
      
      private var var_174:IHabboHelp;
      ...
      private var var_632:FramerateTracker = null;
      
      private var var_262:LatencyTracker = null;
      
      private var var_630:LagWarningLogger = null;
      
      private var var_631:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_632 = new FramerateTracker();
         this.var_262 = new LatencyTracker();
         this.var_630 = new LagWarningLogger();
         this.var_631 = new ToolbarClickTracker(this);
         this.var_1450 = new Array(const_955);
         var _loc4_:int = 0;
         while(_loc4_ < const_955)
         {
            this.var_1450[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1488,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1361,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_854,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_981,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1187)
            {
               this.var_1187.release(new IIDHabboWindowManager());
               this.var_1187 = null;
            }
            if(this.var_282)
            {
            ...
            if(this.var_199)
            {
               ...
               {
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_199).events.removeEventListener(HabboFriendListTrackingEvent.const_386,this.onFriendlistTrackingEvent);
               }
               this.var_199.release(new IIDHabboFriendList());
               this.var_199 = null;
            }
            if(this.var_174)
            {
               ...
               {
                  this.var_174.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_174.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_174.release(new IIDHabboHelp());
               this.var_174 = null;
            }
            if(this.var_180)
            {
               ...
               {
                  this.var_180.events.removeEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
               }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_183)
         {
            if(this.var_262 != null)
            {
               this.var_262.configuration = this.var_183;
            }
            if(this.var_261 != null)
            {
               this.var_261.configuration = this.var_183;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1526);
            if(this.var_183)
            {
               if(this.var_630 != null)
               {
                  this.var_630.configure(this.var_183);
               }
               if(this.var_632 != null)
               {
                  this.var_632.configure(this.var_183);
               }
               if(this.var_631 != null)
               {
                  this.var_631.configure(this.var_183);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_183,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_187,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_234,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_437,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_630 != null)
            {
               this.var_630.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1499);
         }
         else if(param1.type == HabboHotelViewEvent.const_65)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1418);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_886:
               this.trackLoginStep(HabboLoginTrackingStep.const_1623,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_187:
               ...
               break;
            case HabboCommunicationEvent.const_183:
            ...
            case HabboCommunicationEvent.const_234:
               ...
               this.trackLoginStep(HabboLoginTrackingStep.const_234);
               if(this.var_262 != null)
               {
                  this.var_262.init();
               }
      ...
      {
         this.var_1187 = IHabboWindowManager(param2);
         if(this.var_1187)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_183)
            {
               if(this.var_183.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1450)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_963);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_963,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_199 = param2 as IHabboFriendList;
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_199).events.addEventListener(HabboFriendListTrackingEvent.const_386,this.onFriendlistTrackingEvent);
      }
      ...
      {
         this.var_174 = param2 as IHabboHelp;
         this.var_174.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_174.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_981,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_304,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_282 = param2 as IAdManager;
         this.var_282.events.addEventListener(AdEvent.const_557,this.onRoomAdLoad);
      }
      
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_180 = param2 as IHabboToolbar;
         this.var_180.events.addEventListener(HabboToolbarEvent.const_40,this.onToolbarClick);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_631)
         {
            this.var_631.track(param1.iconName);
         }
      }
      ...
      {
         this.var_630.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1889;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1889);
         }
         if(this.var_518 > -1 && _loc2_ - this.var_518 > 15000)
         {
            ++this.var_1890;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1890);
         }
         this.var_518 = _loc2_;
         if(this.var_261 != null)
         {
            this.var_261.update(param1,this.var_518);
         }
         if(this.var_262 != null)
         {
            this.var_262.update(param1,this.var_518);
         }
         if(this.var_632 != null)
         {
            this.var_632.trackUpdate(param1,this,this.var_518);
         }
         if(this.var_630 != null)
         {
            this.var_630.update(this.var_518);
         }
      }
   }
}
