package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      public function configure(param1:IHabboConfigurationManager) : void
      {
         ...
         this.var_1532 = int(param1.getKey("lagWarningLog.interval.seconds","10")) * 1000;
      }
      
      public function chatLagDetected(param1:int) : void
      {
         if(!this.var_1891 || this.var_1532 <= 0)
         {
            return;
         }
         ++this.var_1018;
      ...
      {
         var _loc2_:* = null;
         if(this.var_1018 == 0 || this._connection == null)
         {
            return;
         }
         if(this._lastWarning == 0 || param1 - this._lastWarning > this.var_1532)
         {
            _loc2_ = new LagWarningReportMessageComposer(this.var_1018);
