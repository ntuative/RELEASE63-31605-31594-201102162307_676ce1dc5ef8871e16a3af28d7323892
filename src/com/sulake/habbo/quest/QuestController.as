package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_294:QuestCampaign;
      ...
      {
         if(this.var_641 != MODE_TABS)
         {
            this.var_641 = MODE_NO_TABS;
         }
         this.detachCampaign();
         ...
         this.var_294 = _loc4_;
         this.var_294.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
         if(this.var_641 == MODE_TABS)
         {
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1123.addChild(this.var_294.window);
         var _loc1_:String = "quest_" + this.var_294.code;
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1123 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_153.getKeys())
         {
            ...
            if(!_loc2_)
            {
               _loc2_ = this.var_149.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_454) as ITabButtonWindow;
