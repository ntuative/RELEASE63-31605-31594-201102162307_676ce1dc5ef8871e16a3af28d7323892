package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1069:Number = 1;
      
      private var var_1317:Number = 0;
      
      private var var_1658:Number = 15;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_211 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_1126,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1068 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1068)
         {
         ...
         this.var_1069 = _loc6_.toolbar.@margin_top;
         this.var_1317 = _loc6_.toolbar.@margin_bottom;
         this.var_1658 = _loc6_.toolbar.@min_group_margin;
         this.var_1657 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_274 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_238,param1,param2,this._window,this.var_274);
         this.createGroupsFromXmlList(_loc8_,this.var_577,param1,param2,this.var_211,this.var_274);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_148,this.var_480,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_148,this.var_480);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_148,this.var_480);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_577.length)
         {
            _loc2_ = this.var_577[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_211.x = this.var_148 + this.var_1657;
               this.var_211.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_211.x = 0;
               this.var_211.y = this.var_148 + this.var_1657;
         ...
         _loc4_ -= this.var_1317;
         _loc4_ -= this.var_1069;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1069;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_238.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1658,(this._window.height - _loc5_ * _loc8_ - this.var_1069 - this.var_1317) / (this.var_238.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1658,(this._window.width - _loc5_ * _loc8_ - this.var_1069 - this.var_1317) / (this.var_238.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1068 && this.var_1316)
         {
