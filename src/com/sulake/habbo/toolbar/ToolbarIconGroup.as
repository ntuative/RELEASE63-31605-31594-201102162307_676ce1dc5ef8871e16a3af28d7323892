package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_540:ToolbarBarMenuAnimator;
      ...
      {
         return this.var_1333.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2293.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         return this.var_714.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1334.length)
         {
            _loc2_ = this.var_714.indexOf(this.var_1334[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_286[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1176 + _loc3_);
                  _loc3_ += this.var_1332;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_286[this.var_714.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_540);
