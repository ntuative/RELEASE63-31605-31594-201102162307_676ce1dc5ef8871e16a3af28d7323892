package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            this.var_906 = this.getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(this.var_1366 == true || this.var_904 == 0)
         {
            if(this.var_905.length > 0)
            {
               ++this._frame;
               if(this._frame >= this.var_905.length)
               {
                  this._frame = 0;
                  ++this.var_904;
               }
      ...
      {
         return this.var_905.length;
      }
      
      public function hasNextState() : Boolean
      {
         return this.var_1366 == false && this.var_904 == 1 && this.var_1754 != this._state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         {
            _loc3_ = new BitmapData(Math.max(param2.width,this.var_906.width),Math.max(param2.height,this.var_906.height));
            _loc3_.copyPixels(this.var_906,this.var_906.rect,new Point(0,0));
