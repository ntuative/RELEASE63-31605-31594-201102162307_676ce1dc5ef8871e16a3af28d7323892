package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_430:PlaneBitmapData = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2704 = param9;
         this.var_2700 = param10;
         this.var_2703 = param11;
         this.var_2702 = param12;
         this.var_980 = param6;
      }
      ...
      {
         return this._isVisible && this.var_783;
      }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_430;
         if(_loc3_ == null)
         {
         ...
         if(this.var_783 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_368))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_979 != null)
            {
               _loc3_ = this.var_979.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1911,this.var_2704,this.var_2700,this.var_2703,this.var_2702,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1623 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_783)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1427.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1427[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1051);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_146.z - originZ,this.var_107.z - originZ,this.var_82.z - originZ,this.var_106.z - originZ);
            if(this._type == const_92)
            {
               relativeDepth += 0.02;
            }
            this.var_2222 = relativeDepth;
            this._isVisible = true;
            this.var_1623 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2701);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_113 || this._type == const_92)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_113 || this._type == const_92))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_980)
         {
            ...
            {
               _loc4_ = this.var_266[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_266.length == this.var_981.length)
         {
            while(_loc1_ < this.var_266.length)
            {
               _loc4_ = this.var_266[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_981.length)
                  {
                     _loc7_ = this.var_981[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_980 || this.var_266.length == 0 && this.var_369.length == 0 && !this.var_368 || this.var_766 == null)
         {
            return;
         }
         ...
         if(this.var_368)
         {
            ...
            while(_loc5_ < this.var_266.length)
            {
               _loc3_ = this.var_266[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_68.width - this.var_68.width * _loc3_.leftSideLoc / this.var_281.length;
                  _loc11_ = this.var_68.height - this.var_68.height * _loc3_.rightSideLoc / this.var_280.length;
                  _loc12_ = _loc3_.type;
                  this.var_766.updateMask(this.var_68,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_981.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_369.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  _loc11_ = this.var_68.height - this.var_68.height * _loc4_.rightSideLoc / this.var_280.length;
                  _loc13_ = this.var_68.width * _loc4_.leftSideLength / this.var_281.length;
                  _loc14_ = this.var_68.height * _loc4_.rightSideLength / this.var_280.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_226.copyChannel(param1,param1.rect,new Point(0,0),BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_226.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_226,this.var_226.rect,new Point(0,0),BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
