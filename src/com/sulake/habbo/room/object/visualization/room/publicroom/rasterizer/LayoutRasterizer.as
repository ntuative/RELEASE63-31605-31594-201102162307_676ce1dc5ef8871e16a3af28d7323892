package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_695:IGraphicAssetCollection;
      
      private var var_1809:XMLList;
      ...
      private var var_1214:Point = null;
      
      private var var_1472:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_985)
         {
            this.var_985 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1472 = this.var_42.getValue(this.var_985);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2716 = new Vector3d(-0.5,0.5,0);
         this.var_986 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2716);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
         _loc3_.x = Math.round(_loc3_.x);
         _loc3_.y = Math.round(_loc3_.y);
         this.var_1214.x = _loc3_.x;
         this.var_1214.y = _loc3_.y;
      }
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_42.getValue(this.var_985);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1926 = RoomObjectVariableEnum.const_1040;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1926 = RoomObjectVariableEnum.const_1050;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_42.getValue(this.var_985);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2715 && param3 == this.var_2717)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1926);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_446;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1472.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_695.getAsset(_loc8_.@asset);
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + this.var_1214.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + this.var_1214.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_432.indexOf(_loc10_) >= 0 && this.var_986)
            {
               param1 = this.var_432.indexOf(_loc10_);
               if(this.var_644[param1] != "")
               {
                  _loc9_ = this.var_695.getAsset(this.var_644[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               if(this.var_645[param1] != -1)
               {
                  param2.alpha = this.var_645[param1];
               }
