package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1454:int = const_391;
      ...
      public static const const_233:int = 2;
      
      public static const const_320:int = const_111;
      ...
      private var var_691:Vector3d = null;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_691 != null)
         {
            this.var_691.assign(new Vector3d());
         }
         this.var_560 = 0;
         var _loc1_:int = 0;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_691,param4))
               {
                  if(param1 != null)
                  {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1607 == const_111)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_560);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_560,this.var_30.width,this.var_560);
         }
