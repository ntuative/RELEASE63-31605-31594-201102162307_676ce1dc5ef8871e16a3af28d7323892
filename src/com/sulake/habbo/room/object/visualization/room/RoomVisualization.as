package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1610:int = 16777215;
      
      public static const const_1355:int = 13421772;
      
      private static const const_959:int = 16777215;
      
      private static const const_958:int = 13421772;
      
      private static const const_957:int = 10066329;
      
      private static const const_956:int = 10066329;
      
      public static const const_1554:int = 16777215;
      
      public static const const_1365:int = 13421772;
      
      public static const const_1639:int = 10066329;
      ...
      private var var_520:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_2672:String = null;
      ...
      private const const_1977:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_520 = new RoomPlaneBitmapMaskParser();
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_113 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_964);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1130);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_207,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1610;
               }
               else
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_113,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_278)
            {
               ...
               {
                  _loc13_.color = const_1365;
               }
               else
               {
                  _loc13_.color = const_1639;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1485)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_113,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1977 && !_loc5_ && !_loc7_)
         {
            return;
         }
            ...
            while(_loc9_ < this.var_364.length)
            {
               ...
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_92)
               {
                  if(this.var_1894)
                  {
                     ...
                     _loc14_ = uint((_loc13_ & 255) * this.var_2671 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2673 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1623)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1295 || _loc3_.y != this.var_2220 || _loc3_.z != this.var_2219 || param1.scale != this.var_2223))
            {
               this.var_1295 = _loc3_.x;
               this.var_2220 = _loc3_.y;
               this.var_2219 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            ...
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_662));
            if(_loc4_ != this.var_1189)
            {
               this.var_1189 = _loc4_;
               this.var_2671 = this.var_1189 & 255;
               this.var_2673 = this.var_1189 >> 8 & 255;
               this.var_2674 = this.var_1189 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1054));
            if(_loc5_ != this.var_1894)
            {
               this.var_1894 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_165 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_769);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_733);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_814);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_817));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_837));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_768));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_122.length)
         {
            ...
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_207 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_113 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_207)
                        {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1738;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_520.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_520.maskCount)
         {
            _loc10_ = this.var_520.getMaskType(_loc8_);
            _loc11_ = this.var_520.getMaskLocation(_loc8_);
            _loc12_ = this.var_520.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_122.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_92)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_113 || _loc3_.type == RoomPlane.const_92 && _loc12_ == RoomPlaneBitmapMaskData.const_227)
                              {
