package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1074:Number = 1.0;
      
      private var var_583:BitmapData;
      
      private var var_711:ColorTransform;
      
      private var var_1326:ColorTransform;
      
      private var var_1671:Matrix;
      
      private var _translationMatrix:Matrix;
      
      private var var_789:Number = 1.0;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1326 = new ColorTransform();
         this.var_1671 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_93 = this.var_1075[param1];
         this.var_874 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1670 >= 0)
         {
            this.var_240 = this._visualization.getSprite(this.var_1670);
            if(this.var_240 && this.var_240.asset)
            {
               ...
               if(this.var_83 == null)
               {
                  ...
                  {
                     this.var_583 = new BitmapData(this.var_83.width,this.var_83.height,true,4278190080);
                  }
               }
               this.var_2187 = -this.var_240.offsetX;
               this.var_2188 = -this.var_240.offsetY;
            ...
            if(this.var_583)
            {
               this.var_583.fillRect(this.var_583.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_93.y * this.var_1074;
         }
         return 0;
      }
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_874 && this.var_93.hasIgnited)
         {
            this.var_874 = true;
         }
         _loc8_ = this.var_1103 * this.var_1074;
         this.var_93.update();
         if(this.var_874)
         {
            if(this.var_93.roomObjectSpriteId >= 0)
            ...
            {
               this.var_83.draw(this.var_583,this.var_1671,this.var_711,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_93.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2187 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1074;
               _loc4_ = this.var_2188 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1074;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1326.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_83.draw(_loc7_,this._translationMatrix,this.var_1326,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         var _loc23_:* = null;
         var _loc24_:* = null;
         this.var_2284 = parseInt(param1.@size);
         this.var_1670 = !!param1.hasOwnProperty("@canvas_id") ? int(parseInt(param1.@canvas_id)) : -1;
         this.var_1103 = !!param1.hasOwnProperty("@offset_y") ? int(parseInt(param1.@offset_y)) : 10;
         this.var_1074 = this.var_2284 / 64;
         this.var_789 = !!param1.hasOwnProperty("@blend") ? Number(Number(param1.@blend)) : Number(1);
         this.var_789 = Math.min(this.var_789,1);
         this.var_711.alphaMultiplier = this.var_789;
