package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1655:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2732:Number = NaN;
      
      protected var var_2733:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1233:String = null;
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1170:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1018:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_438 != _loc3_.getUpdateID() || param1 != var_185 || param2 != this.var_2732)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2733 = _loc3_.getNumber(RoomObjectVariableEnum.const_252);
            ...
            this.var_1233 = _loc3_.getString(RoomObjectVariableEnum.const_378);
            if(this.var_1233 == null || this.var_1233.indexOf("http") != 0)
            {
               this.var_1233 = null;
            }
      ...
      {
         if(this.var_2146 != param2 || this.var_2144 != param1)
         {
            this.var_832 = [];
            this.var_831 = [];
            this.var_679 = [];
            ...
            this.var_2145 = this.getSize(param1);
            this.var_570 = this._data.getLayerCount(param1) + this.getAdditionalSpriteCount();
            this.var_1586 = this.var_570 - this.getAdditionalSpriteCount();
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_497.length)
         {
            return "";
         }
         ...
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 != this.var_1586)
            {
               _loc6_ = FurnitureVisualizationData.const_497[param2];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_681[param3] != null && !this.var_1587)
         {
      ...
      {
         if(this.var_682[param2] != null)
         {
            return this.var_682[param2];
         }
         if(this._data == null)
         {
