package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1567:String = "cone";
      
      public static const const_1618:String = "plane";
      
      public static const const_1640:String = "sphere";
      ...
      private var var_957:Number = 0.1;
      ...
      public function reset() : void
      {
         ...
         this.var_956 = 0;
         this.var_874 = false;
         this.init(0,0,0,this._direction,this.var_2615,this.var_957,this.var_2616,true);
      }
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2619)
         {
            switch(this.var_2620)
            {
               case const_1567:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_957,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_956 < this.var_1437)
         {
            if(this.age % this.var_2618 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_956 < this.var_1437)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_260) * this.x - (1 - this.var_260) * this.lastX;
            this.y = (2 - this.var_260) * this.y - (1 - this.var_260) * this.lastY + this.var_1863 * this.var_957 * this.var_957;
            this.z = (2 - this.var_260) * this.z - (1 - this.var_260) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_362)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_260) * _loc2_.x - (1 - this.var_260) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_260) * _loc2_.y - (1 - this.var_260) * _loc2_.lastY + this.var_1863 * this.var_957 * this.var_957;
            _loc2_.z = (2 - this.var_260) * _loc2_.z - (1 - this.var_260) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
