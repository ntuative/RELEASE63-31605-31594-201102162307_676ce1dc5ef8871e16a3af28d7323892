package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_556:PetVisualizationData = null;
      ...
      private const const_1942:int = 3;
      ...
      private const const_1219:int = 3;
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_456.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_456.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
      ...
      {
         this.var_556 = param1 as PetVisualizationData;
         createSprites(this.const_1219);
         var _loc2_:BitmapData = (this.var_556.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         if(param1.getUpdateID() != var_165)
         {
            ...
            this.var_1258 = param1.getString(RoomObjectVariableEnum.const_258);
            this.var_233 = param1.getString(RoomObjectVariableEnum.const_329);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_882);
            this.var_1526 = param1.getNumber(RoomObjectVariableEnum.const_297);
            this.var_1257 = param1.getNumber(RoomObjectVariableEnum.const_804);
            this.var_2045 = param1.getNumber(RoomObjectVariableEnum.const_760);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_188);
            if(this.var_544 != _loc3_)
            {
               this.var_544 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_438 != param1.getUpdateID() || this.var_1623 != param2.updateId)
         {
            _loc4_ = param1.getDirection().x - param2.direction.x;
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = this.var_1526;
            ...
            if(_loc4_ != this.var_1595 || param3)
            {
               this.var_1595 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_54.setDirectionAngle(AvatarSetType.const_34,_loc4_);
            }
            if(_loc5_ != this.var_1596 || param3)
            {
               this.var_1596 = _loc5_;
               _loc5_ -= 112.5;
               _loc5_ = (_loc5_ + 360) % 360;
               this.var_54.setDirectionAngle(AvatarSetType.const_48,_loc5_);
            }
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         var _loc3_:IAvatarImage = this.var_456.getValue(_loc2_) as IAvatarImage;
         if(_loc3_ == null)
         {
            _loc3_ = this.var_556.getAvatar(this.var_544,param1,this);
            if(_loc3_ != null)
            {
               this.var_456.add(_loc2_,_loc3_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_557 = null;
         _loc2_ = getSprite(this.const_1661);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc9_ || _loc6_ != var_185 || this.var_54 == null)
         {
            if(_loc6_ != var_185)
            {
               var_185 = _loc6_;
         ...
         var _loc11_:Boolean = this.var_854 || this.var_1015 > 0 || this.var_1525;
         this._experienceData.alpha = 0;
         if(this.var_1257 > 0)
         {
            _loc12_ = param2 - this.var_1257;
            if(_loc12_ < AvatarAction.const_933)
            {
               ...
               this.var_1015 = this.const_1942;
            }
            else
            {
               this.var_1257 = 0;
            }
            _loc13_ = getSprite(this.const_1673);
            if(_loc13_ != null)
            {
         ...
         if(_loc10_ || _loc11_)
         {
            ...
            _loc13_ = getSprite(this.const_911);
            if(_loc13_)
            {
               _loc18_ = this.var_54.getImage(AvatarSetType.const_34,false);
               if(_loc18_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1258 != null && this.var_1258 != "")
         {
            param1.appendAction(AvatarAction.const_317,this.var_1258);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1219;
