   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2486 = param1.extra;
            this.var_1142 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1142 > 0 && param1 >= this.var_1142)
         {
            this.var_1142 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1754,String(this.var_1754),this.var_2486);
