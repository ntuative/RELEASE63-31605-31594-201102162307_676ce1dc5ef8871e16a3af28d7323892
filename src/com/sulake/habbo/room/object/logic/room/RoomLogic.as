package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1411:uint = 16777215;
      
      private var var_1820:int = 255;
      
      private var var_1152:uint = 16777215;
      
      private var var_1821:int = 255;
      
      private var var_1151:int = 0;
      
      private var var_1819:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_964,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_662,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_817,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_837,1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1151)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1614;
            if(_loc2_ - this.var_1151 >= this.var_1819)
            {
               _loc3_ = this.var_1152;
               _loc4_ = this.var_1821;
               this.var_1151 = 0;
            }
            else
            {
               _loc7_ = this.var_1411 >> 16 & 255;
               _loc8_ = this.var_1411 >> 8 & 255;
               _loc9_ = this.var_1411 & 255;
               _loc10_ = this.var_1152 >> 16 & 255;
               _loc11_ = this.var_1152 >> 8 & 255;
               _loc12_ = this.var_1152 & 255;
               _loc13_ = (_loc2_ - this.var_1151) / this.var_1819;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1820 + (this.var_1821 - this.var_1820) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_662,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_679:
               param2.setString(RoomObjectVariableEnum.const_733,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_767:
               param2.setString(RoomObjectVariableEnum.const_769,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_803:
               param2.setString(RoomObjectVariableEnum.const_814,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_568:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_227)
               {
                  _loc5_ = "null";
               }
               this.var_520.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_884:
               _loc4_ = this.var_520.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_520.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1109:
               param2.setNumber(RoomObjectVariableEnum.const_817,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_991:
               param2.setNumber(RoomObjectVariableEnum.const_837,_loc3_);
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1411 = this._color;
         this.var_1820 = this.var_1614;
         this.var_1152 = _loc3_;
         this.var_1821 = _loc4_;
         this.var_1151 = getTimer();
         this.var_1819 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_514,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1479,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1645,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1505,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_514,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_167 || _loc13_ == RoomPlaneData.const_278)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
