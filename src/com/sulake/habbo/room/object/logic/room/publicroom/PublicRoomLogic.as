package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_862,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_498,Number(false));
         this.var_712 = true;
      }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_1161:
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_862,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_498,Number(true));
                  this.var_1390 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_1190);
            }
         }
      }
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_498,Number(false));
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_446)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_862);
            ...
            case MouseEvent.ROLL_OVER:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_446)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_400,_loc5_,_loc6_));
               }
               break;
