package com.sulake.habbo.room.object.logic
{
   ...
   public class AvatarLogic extends MovingObjectLogic
   {
      ...
      private static const const_902:int = 28;
      
      private static const const_903:int = 29;
      
      private static const const_901:int = 500;
      
      private static const const_1228:int = 999999999;
      ...
      {
         super();
         this.var_1575 = getTimer() + this.getBlinkInterval();
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarChatUpdateMessage)
         {
            ...
            this.var_1276 = getTimer() + _loc4_.numberOfWords * 1000;
            return;
         }
         if(param1 is RoomObjectAvatarTypingUpdateMessage)
         {
            _loc5_ = param1 as RoomObjectAvatarTypingUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_1010,Number(_loc5_.isTyping));
            return;
         }
         if(param1 is RoomObjectAvatarUpdateMessage)
         {
            _loc6_ = param1 as RoomObjectAvatarUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_297,_loc6_.dirHead);
            return;
         }
         if(param1 is RoomObjectAvatarGestureUpdateMessage)
         {
            _loc7_ = param1 as RoomObjectAvatarGestureUpdateMessage;
            _loc2_.setNumber(RoomObjectVariableEnum.const_258,_loc7_.gesture);
         ...
         if(param1 is RoomObjectAvatarWaveUpdateMessage)
         {
            ...
            if(_loc8_.isWaving)
            {
               ...
               this.var_1030 = getTimer() + 0;
            }
            else
            {
               _loc2_.setNumber(RoomObjectVariableEnum.const_353,0);
               this.var_1030 = 0;
            }
            return;
         }
         ...
         if(param1 is RoomObjectAvatarPlayerValueUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_696,_loc11_.value);
         ...
         if(param1 is RoomObjectAvatarCarryObjectUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_526,_loc15_.itemType);
            if(_loc15_.itemType < const_1228)
            {
         ...
         if(param1 is RoomObjectAvatarSignUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1155,_loc17_.signType);
            this.var_1274 = getTimer() + 5000;
            return;
         }
         if(param1 is RoomObjectAvatarFlatControlUpdateMessage)
         {
            _loc18_ = param1 as RoomObjectAvatarFlatControlUpdateMessage;
            _loc2_.setString(RoomObjectVariableEnum.const_617,_loc18_.rawData);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1382,Number(_loc18_.isAdmin));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1174,_loc22_);
            return;
         }
         if(param1 is RoomObjectAvatarSelectedMessage)
         {
            _loc23_ = param1 as RoomObjectAvatarSelectedMessage;
            this.var_202 = _loc23_.selected;
            this.var_461 = null;
            return;
         }
      }
      ...
      private function updateEffect(param1:int, param2:int, param3:IRoomObjectModelController) : void
      {
         if(param1 == const_902)
         {
            this.var_673 = getTimer() + const_901;
            this.var_1273 = const_903;
         }
         else if(param3.getNumber(RoomObjectVariableEnum.const_499) == const_903)
         {
            this.var_673 = getTimer() + const_901;
         ...
         param3.setNumber(RoomObjectVariableEnum.const_499,param1);
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(param1.type)
         {
            case MouseEvent.CLICK:
               ...
               if(eventDispatcher != null)
               {
                  _loc5_ = new RoomObjectMouseEvent(RoomObjectMouseEvent.const_250,param1.eventId,_loc3_,_loc4_,param1.altKey,param1.ctrlKey,param1.shiftKey,param1.buttonDown);
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         if(this.var_1276 > 0)
         {
            ...
            else if(this.var_830 == 0 && this.var_672 == 0)
            {
               this.var_672 = param1 + this.getTalkingPauseInterval();
               this.var_830 = this.var_672 + this.getTalkingPauseLength();
            }
            ...
            else if(this.var_830 > 0 && param1 > this.var_830)
            {
               param2.setNumber(RoomObjectVariableEnum.const_226,1);
               this.var_830 = 0;
            }
         }
         ...
         {
            param2.setNumber(RoomObjectVariableEnum.const_258,0);
            this.var_1275 = 0;
         }
         if(this.var_1274 > 0 && param1 > this.var_1274)
         {
            param2.setNumber(RoomObjectVariableEnum.const_1155,0);
            this.var_1274 = 0;
         }
         if(this.var_829 > 0)
         {
            ...
            {
               param2.setNumber(RoomObjectVariableEnum.const_526,0);
               this.var_829 = 0;
            }
            else if((this.var_829 - param1) % 10000 < 1000 && this.var_1574)
            {
         ...
         if(param1 > this.var_1575)
         {
            param2.setNumber(RoomObjectVariableEnum.const_751,1);
            this.var_1575 = param1 + this.getBlinkInterval();
            this.var_1271 = param1 + this.getBlinkLength();
         }
         if(this.var_1271 > 0 && param1 > this.var_1271)
         {
            param2.setNumber(RoomObjectVariableEnum.const_751,0);
            this.var_1271 = 0;
         }
         if(this.var_673 > 0 && param1 > this.var_673)
         {
            param2.setNumber(RoomObjectVariableEnum.const_499,this.var_1273);
            this.var_673 = 0;
         }
