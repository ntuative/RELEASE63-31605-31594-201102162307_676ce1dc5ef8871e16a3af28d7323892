   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_872,this.onAvatarEffectsChanged);
               this._inventory.events.removeEventListener(HabboInventoryHabboClubEvent.const_776,this.onHabboClubSubscriptionChanged);
            }
            if(this.var_180 != null)
            {
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
               this.var_180.events.removeEventListener(HabboToolbarEvent.const_40,this.onHabboToolbarEvent);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_448,this.onHelpTutorialEvent);
         ...
         if(this._inventory != null)
         {
            this._inventory.events.addEventListener(HabboInventoryEffectsEvent.const_872,this.onAvatarEffectsChanged);
            this._inventory.events.addEventListener(HabboInventoryHabboClubEvent.const_776,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp != null)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_448,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc2_ != this.var_1394)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc4_.setDirection(AvatarSetType.const_48,3);
                  _loc1_ = _loc4_.getCroppedImage(AvatarSetType.const_48);
                  _loc4_.dispose();
               }
               this.var_1394 = _loc2_;
         ...
         if(this.var_180 != null)
         {
            _loc5_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1043,HabboToolbarIconEnum.MEMENU);
            if(_loc1_ != null)
            {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_887);
         _loc1_.push(RoomWidgetDanceMessage.const_727);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_841);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_644);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_765);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_672);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_634);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_365);
         _loc1_.push(RoomWidgetStopEffectMessage.const_648);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1628);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1151);
         _loc1_.push(RoomWidgetToolbarMessage.const_706);
         _loc1_.push(RoomWidgetToolbarMessage.const_840);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_385);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1364);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_997);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_794);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_608);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_890);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1501);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_703);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_625);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_849);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_394);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_608:
               ...
               break;
            case RoomWidgetWaveMessage.const_887:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_727:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_841:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_765:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_365:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_984)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_173,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_634:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1073:
                        this._catalog.openCatalogPage(CatalogPageName.const_1494,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1117:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_285);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1600:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_80);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1424:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_672:
            case RoomWidgetStopEffectMessage.const_648:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1151:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_794:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_706:
               ...
               if(this.var_180)
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(this._inventory != null)
                  {
                     _loc12_ = false;
                     if(this._container != null && this._container.sessionDataManager != null)
                     {
                        _loc12_ = this._container.sessionDataManager.hasUserRight("fuse_use_club_dance",HabboClubLevelEnum.const_39);
                     }
               ...
               break;
            case RoomWidgetToolbarMessage.const_840:
               ...
               {
                  this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_451,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_385:
               ...
               if(this._container)
               {
                  ...
                  _loc21_ = 0;
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_club_outfits",HabboClubLevelEnum.const_39))
                  {
                     _loc21_ = 0;
                  }
                  if(this._container.sessionDataManager.hasUserRight("fuse_use_vip_outfits",HabboClubLevelEnum.const_42))
                  {
                     _loc21_ = 0;
                  }
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_492));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_890:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_331,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetStoreSettingsMessage.const_625:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_331,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_849:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_441));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_394:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_619));
               break;
            default:
