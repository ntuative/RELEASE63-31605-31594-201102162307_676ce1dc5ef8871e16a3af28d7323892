package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_734:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_408 != null)
         {
            ...
            {
               _loc2_ = this.var_408.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1125)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_759,RoomWidgetChatSelectAvatarMessage.const_851];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_759:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_39) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1021))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_39) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1021))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_851:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_408.getValue(_loc16_) as BitmapData;
                           }
                              ...
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_48);
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_408.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1124 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1124);
            }
            if(this.var_734 == null)
            {
               ...
               this.var_493.y = 0;
               this.var_493.z = 0;
               this.var_734 = _loc4_.getScreenPoint(this.var_493);
               this.var_1124 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_493.x = 0;
            this.var_493.y = 0;
            this.var_493.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_493);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_734.x || _loc8_.y != this.var_734.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_734,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_408)
         {
            _loc2_ = this.var_408.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1125.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1763.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1763.remove(param1);
         if(_loc3_ != null)
         {
