package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_862:IHabboModeration;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_581:IHabboSoundManager;
      ...
      private var var_1059:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1303 = RoomDesktop.const_459;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_581.release(new IIDHabboSoundManager());
            this.var_581 = null;
         }
         ...
         {
            this.var_862.release(new IIDHabboModeration());
            this.var_862 = null;
         }
         ...
         if(this.var_1059)
         {
            this.var_1059.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1059 = null;
         }
         this.var_1638 = null;
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_282.events.addEventListener(AdEvent.const_559,this.adEventHandler);
            this.var_282.events.addEventListener(AdEvent.const_442,this.adEventHandler);
            this.var_282.events.addEventListener(AdEvent.const_557,this.adEventHandler);
         }
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_862 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_862);
      }
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_581 = param2 as IHabboSoundManager;
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_238,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_179,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_315,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_419,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_540,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_474,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_440,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_240,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_243,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_685,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1157,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1165,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_888,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_169,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_856,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_699,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_546,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_449,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               if(param1.session != null)
               {
                  ...
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.ZOOM));
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.MEMENU));
                  this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_1059 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_713,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_836,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_870,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_458,this.roomEngineEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_782,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_726,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_735,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_713)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_575 || param1.type == RoomEngineEvent.const_458)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_836:
               _loc5_ = false;
               ...
               if(this._roomEngine != null)
               {
                  ...
                  {
                     _loc7_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.ZOOM);
                     _loc7_.iconState = "2";
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_677);
               ...
               if(this._config.getKey("avatar.widget.enabled","0") == "1")
               {
                  ...
                  _loc3_.initializeWidget(RoomWidgetEnum.const_100);
               }
               if(this._config.getKey("purse.widget.enabled","0") == "1")
               {
                  _loc3_.createWidget(RoomWidgetEnum.const_374);
                  _loc3_.initializeWidget(RoomWidgetEnum.const_374);
               }
               if(!_loc5_)
               {
               ...
               if(this.var_1303 != RoomDesktop.const_459)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_293,this.var_1303);
               }
               if(this.var_282 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_870:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_782:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.moderation = this.var_862;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_581;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1059;
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_459)
            {
               this.var_1303 = _loc3_;
            }
            _loc2_.dispose();
         }
      }
