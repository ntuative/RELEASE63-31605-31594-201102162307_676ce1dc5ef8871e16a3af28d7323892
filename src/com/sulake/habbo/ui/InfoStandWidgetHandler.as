   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_158,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_149,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_158,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_149,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_545.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_545.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_330);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_318);
         _loc1_.push(RoomWidgetFurniActionMessage.const_850);
         _loc1_.push(RoomWidgetFurniActionMessage.const_635);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_660);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_663);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_839);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1434);
         _loc1_.push(RoomWidgetPetCommandMessage.const_577);
         _loc1_.push(RoomWidgetPetCommandMessage.const_645);
         _loc1_.push(RoomWidgetUserActionMessage.const_422);
         _loc1_.push(RoomWidgetUserActionMessage.const_383);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_830);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_553)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_383 || param1.type == RoomWidgetUserActionMessage.const_422 || param1.type == RoomWidgetUserActionMessage.const_516)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_330:
            ...
            case RoomWidgetUserActionMessage.const_709:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_978,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_383:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_660:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_663:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_839:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc24_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_355);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1127);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1184);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_1153)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc13_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_526);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_123)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_136)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc31_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_617);
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1020;
                  }
                  if(!_loc28_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1120;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1537);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_545.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_545.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_617);
