package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_1016:SliderWindowController;
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_1016.getValue());
      ...
      {
         this.var_89 = param2;
         this.var_1016 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_1016.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_1016.setValue(1);
         this.var_1202 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1202.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_1016.setValue(_loc3_);
         this.var_1202.setValue(_loc4_);
      }
