package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1212:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1212,param1);
         this.var_983 = param1;
         if(param2)
         {
      ...
      {
         return int(this.var_1542 * (Number(param1 - this._minValue) / (this.var_1212 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1542 * (this.var_1212 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_984)
         {
            if(param1.type == WindowMouseEvent.const_58 || param1.type == WindowMouseEvent.const_175)
            {
               this.var_984 = false;
            }
         }
         if(!this.var_984 || param1.type != WindowEvent.const_396)
         {
            return;
         }
         if(this.var_642 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_642) * this.var_642;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_642 != 0)
            {
               _loc3_ = this.var_983 + this.var_642;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_666 != null)
            {
               ...
               this.var_1542 = _loc1_.width - _loc2_.width;
            }
         }
