package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1689:int = 0;
      ...
      private const const_1684:int = 4;
      
      private const const_1955:int = 0;
      
      private const const_1957:int = 1;
      
      private const const_1959:int = 2;
      
      private const const_1956:int = 3;
      
      private const const_1952:int = 4;
      
      private const const_1954:int = 5;
      
      private const const_1686:String = "deco_img";
      
      private const const_1688:String = "dialog_bg";
      
      private const const_1958:String = "%campaign%_dialog_bg.png";
      
      private const const_324:String = "%campaign%_gift_package.png";
      
      private const const_1951:String = "%campaign%_gift_content.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this._imageUrlPath = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_698,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_574:
               ...
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_698:
               ...
               this._shareId = null;
               this.var_1324 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1325 != _loc2_ || _loc3_ != this.var_175))
         {
         ...
         if(!this._window)
         {
            switch(this.var_1325)
            {
               ...
               case this.const_1687:
                  if(this.var_375 == this.const_1955)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_locked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.locked");
                     _loc2_ = this.const_324;
                  }
                  else if(this.var_375 == this.const_1957)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_unlocked") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.unlocked");
                     _loc2_ = this.const_1951;
                  }
                  else if(this.var_375 == this.const_1959)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.no_fb");
                     _loc3_ = var_78.getKey("widget.furni.teaser.gift.no_fb.title");
                     _loc4_ = var_78.getKey("widget.furni.teaser.gift.no_fb.desc");
                     _loc2_ = this.const_324;
                  }
                  else if(this.var_375 == this.const_1956)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.not_enough_fb_friends");
                     _loc3_ = var_78.getKey("widget.furni.teaser.gift.no_spam.title");
                     _loc4_ = var_78.getKey("widget.furni.teaser.gift.no_spam.desc");
                     _loc2_ = this.const_324;
                  }
                  else if(this.var_375 == this.const_1952)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_375 == this.const_1954)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_175,"client.show.campaign_closed");
            ...
            _loc5_ = this.const_1958.replace("%campaign%",this.var_175);
            this.setDecoImage(_loc5_,this.const_1688);
            _loc2_ = _loc2_.replace("%campaign%",this.var_175);
            this.setDecoImage(_loc2_,this.const_1686);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_739);
      ...
      {
         this.sendConversionPoint("viral_" + this.var_175,"client.skip_post");
         this.hideInterface();
      }
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         this.sendConversionPoint("viral_" + this.var_175,"client.start_post",this._shareId);
         var _loc4_:String = this.var_158.getKey("viral.furni.post_type","feed");
         HabboWebTools.facebookViralGiftPost(this.var_175,_loc2_,_loc3_,this._shareId,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_159);
         ...
         if(this._inventory)
         {
            if(this.var_1324 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1324 == 1 ? "null" : InventoryCategory.const_140);
            }
         }
         this.sendConversionPoint("viral_" + this.var_175,"client.open_gift");
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_818,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1323.push(new ImageDownloader(this,_assets,this.var_175,this._imageUrlPath,param1,param2));
            return;
         }
      ...
      {
         if(!this._window || this.var_175 != param1.campaignID)
         {
            return;
         }
