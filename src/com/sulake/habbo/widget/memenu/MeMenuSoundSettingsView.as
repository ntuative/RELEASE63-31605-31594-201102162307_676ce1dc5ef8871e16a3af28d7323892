package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1715:BitmapData;
      ...
      {
         this.var_481 = param1.volume;
         if(this.var_891 != null)
         {
            this.var_891.setValue(this.var_481);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_890));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_481 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1713);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1715);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_481 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1714);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1716);
         }
      }
