package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1208:int = 18;
      ...
      private var var_167:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_742 = false;
         this._widget = param1;
         this.var_167 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         this.var_167.state = RoomChatHistoryPulldown.const_254;
         ...
         this.var_46 = param2.createWindow("chatscroller","",HabboWindowType.const_1107,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_167.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_254);
      }
      ...
      {
         return !!this.var_381 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_167.state == RoomChatHistoryPulldown.const_403 || this.var_167.state == RoomChatHistoryPulldown.const_523;
      }
      ...
      {
         if(!this.var_381 && !this.var_1616)
         {
            this.var_381 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_167.state = RoomChatHistoryPulldown.const_403;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_46 != null)
         {
            ...
            if(param2)
            {
               this.var_46.scrollV = this.var_537;
            }
         }
         if(this.var_167 != null)
         {
            this.var_167.containerResized(param1);
         }
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_380 > 0 && param2)
         {
            if(this.var_1494)
            {
               if(Math.abs(param1 - this.var_380) <= const_1110)
               {
                  return;
               }
               this.var_1494 = false;
            ...
            if(this.var_381)
            {
               ...
               _loc5_ = (param1 - this.var_380) / this.var_46.height;
               _loc3_ = this.var_537 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_380;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_46.scrollV < 1 - const_1208 / this.var_46.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_1493)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_46 != null)
         {
            this.var_537 = this.var_46.scrollV;
         }
         if(this.var_46 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_537 - this.var_46.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
