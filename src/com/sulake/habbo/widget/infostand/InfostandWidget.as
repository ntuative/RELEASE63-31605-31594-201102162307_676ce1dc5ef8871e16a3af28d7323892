package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1675:String = "infostand_pet_view";
      
      private const const_1676:String = "infostand_bot_view";
      
      private var var_1058:InfoStandFurniView;
      ...
      private var var_1302:InfostandUserData;
      
      private var var_468:InfostandFurniData;
      ...
      private const const_1947:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboCatalog)
      {
         ...
         this.var_1058 = new InfoStandFurniView(this,this.const_1678,this._catalog);
         this.var_126 = new InfoStandUserView(this,this.const_1677);
         this.var_337 = new InfoStandPetView(this,this.const_1675,this._catalog);
         this.var_394 = new InfoStandBotView(this,this.const_1676);
         this.var_1302 = new InfostandUserData();
         this.var_468 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_147 = new Timer(this.const_1947);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_57,HabboWindowStyle.const_41,HabboWindowParam.const_41,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_133,this.onClose);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_288,this.onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_135,this.onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_747,this.onUserGivableBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_749,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_133,this.onClose);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_288,this.onRoomObjectRemoved);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_135,this.onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetUserGivableBadgesUpdateEvent.const_747,this.onUserGivableBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_749,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_383,this.var_337.getCurrentPetId()));
      }
      ...
      private function onBotInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.selectView(this.const_1676);
         if(this.var_147)
         {
            this.var_147.stop();
         }
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_126.setTags(param1.tags,this.var_2239);
         }
      }
