package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_814 = this.var_201.findChildByTag("catalog");
         if(this.var_814 != null)
         {
            this.var_814.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_51.addListItem(this.var_814);
            }
            this.var_814.visible = param1;
         }
         else
         {
            this.var_51.removeListItem(this.var_814);
         }
      }
   }
}
