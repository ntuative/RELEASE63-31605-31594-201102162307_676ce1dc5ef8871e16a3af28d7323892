package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_396:IFrameWindow;
      ...
      private const const_1948:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_338 = new Timer(this.const_1948);
         this.var_338.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1067.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_479);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1067.getValue(this.var_479) as CommandConfiguration;
      ...
      {
         this.var_1067.remove(param1);
         this.var_1067.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_38.setParamFlag(WindowParam.const_94,true);
         this.var_38.context.getDesktopWindow().addEventListener(WindowEvent.const_49,this.onWindowDesktopResized);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_396 == null)
         {
            ...
            this.var_396 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_396 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_396.x = 200;
            this.var_396.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_383,this.var_479));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_577,this.var_479,this.var_1656 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_577,this.var_479,this.var_1656 + " " + _loc5_);
