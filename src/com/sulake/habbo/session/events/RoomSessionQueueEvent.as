package com.sulake.habbo.session.events
{
   ...
   public class RoomSessionQueueEvent extends RoomSessionEvent
   {
      ...
      public static const const_1022:String = "c";
      
      public static const const_1546:String = "d";
      
      public static const const_1051:int = 2;
      ...
      {
         return this.var_1443.getKeys();
      }
      
      public function getQueueSize(param1:String) : int
      {
         return this.var_1443.getValue(param1);
      }
      
      public function addQueue(param1:String, param2:int) : void
      {
         this.var_1443.add(param1,param2);
      }
   }
}
