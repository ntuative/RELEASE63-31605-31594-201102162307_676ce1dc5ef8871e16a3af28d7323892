package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1973:int = 2500;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1407));
         this.var_1408.add(this.var_1407,getTimer());
         ++this.var_1407;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1408.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1973)
            {
