package com.sulake.habbo.friendlist
{
   ...
   public class FriendListTabsView
   {
      ...
      public function refresh(param1:String) : void
      {
         ...
         this.var_179.width = this._friendList.tabs.tabContentWidth;
         this.var_179.findChildByName("bg").width = this._friendList.tabs.tabContentWidth;
         var _loc2_:int = 1;
         for each(_loc3_ in this._friendList.tabs.method_4())
         {
            _loc4_ = this.var_179.getChildByName("flt_" + _loc3_.id) as IWindowContainer;
         ...
         this.var_179.height = _loc2_ + 1;
         this.var_179.findChildByName("bg").height = this.var_179.height;
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.tabs.method_4())
         {
