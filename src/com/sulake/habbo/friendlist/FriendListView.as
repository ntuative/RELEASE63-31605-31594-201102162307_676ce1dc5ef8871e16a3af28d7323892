package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1680:String = "messageinput";
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1306 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this._friendList.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.FRIENDLIST,this.var_17));
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_1306.prepare(this.var_881);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_999,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_973,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_614,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_827,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_614,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_827,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1307 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1307.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1644 == -1 ? 0 : int(this.var_17.height - this.var_1644);
         var _loc4_:int = this.var_1645 == -1 ? 0 : int(this.var_17.width - this.var_1645);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1181,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_614,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_999,false);
         ...
         this.var_1644 = this.var_17.height;
         this.var_1645 = this.var_17.width;
      ...
      public function get method_1() : IWindowContainer
      {
         return this.var_17;
      }
