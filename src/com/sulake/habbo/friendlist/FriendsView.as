package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_652:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2719:IContainerButtonWindow;
      
      private var var_2721:IContainerButtonWindow;
      
      private var var_2720:IContainerButtonWindow;
      
      private var var_2718:IContainerButtonWindow;
      
      private var var_58:IItemListWindow;
      
      private var var_390:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_390 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2719 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2721 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2720 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2718 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_652);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_95,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_652);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2719,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2721,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2720,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2718,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_390.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_390.showPopup(this._friendList.view.method_1,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_390.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_273)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_273 && _loc4_.online)
            {
