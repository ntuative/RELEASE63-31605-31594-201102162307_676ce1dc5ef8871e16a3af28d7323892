package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_780:ISessionDataManager;
      
      private var var_2696:FriendListLookAndFeel;
      
      private var var_389:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1907:OpenedToWebPopup;
      ...
      private var var_1906:AvatarSearchResults;
      ...
      {
         this.var_2696 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_95 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1906 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_638.stop();
            this.var_638.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_638 = null;
         }
         ...
         if(this.var_1126)
         {
            this.var_1126.release(new IIDAvatarRenderManager());
            this.var_1126 = null;
         }
         if(this.var_868)
         {
         ...
         if(this.var_780)
         {
            this.var_780.release(new IIDSessionDataManager());
            this.var_780 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1907 = new OpenedToWebPopup(this);
         }
         this.var_1907.show(x,y);
      }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.FRIENDLIST);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_290,HabboWindowStyle.const_41,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1126.createAvatarImage(param1,AvatarScaleType.const_88,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_780 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_1005,this.getText("friendlist.friends")));
         this.var_95.addCategory(new FriendCategory(FriendCategory.const_382,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_638)
         {
            this.var_638 = new Timer(120000);
            this.var_638.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_638.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_95.findCategory(FriendCategory.const_382);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_389.findTab(FriendListTab.const_98).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_389.findTab(FriendListTab.const_98);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1906.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_389.findTab(FriendListTab.const_98);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_780 || !this.var_367)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_780.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_42))
         {
            _loc2_ = this.var_367.vipLimit;
         }
         else if(this.var_780.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_39))
         {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_160) as IBitmapWrapperWindow;
