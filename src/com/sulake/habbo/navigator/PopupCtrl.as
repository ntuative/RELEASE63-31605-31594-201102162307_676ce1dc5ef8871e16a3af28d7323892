package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_433.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_433)
         {
            this.var_433.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_433.reset();
            this.var_433 = null;
         }
         if(this.var_373)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_53 == null)
         {
            this.var_53 = IWindowContainer(this._navigator.getXmlWindow(this.var_992));
            this.var_53.visible = false;
            this.var_53.setParamFlag(HabboWindowParam.const_35,true);
         ...
         this.var_53.x = _loc2_.x + this.var_2164 + param1.width;
