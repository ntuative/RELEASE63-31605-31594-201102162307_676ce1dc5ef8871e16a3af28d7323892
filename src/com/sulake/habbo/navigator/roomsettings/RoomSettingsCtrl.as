package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_431:IRoomSettingsCtrlOwner;
      ...
      private var var_808:TextFieldManager;
      
      private var var_982:TextFieldManager;
      
      private var var_1210:TextFieldManager;
      ...
      private var var_2709:ITextWindow;
      
      private var var_2710:ITextWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1921 = true;
         this.var_431.roomSettingsRefreshNeeded();
      }
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1209 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1587)
         {
            this.var_785.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1627)
         {
            this.var_785.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1414)
         {
            this.var_1206.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1409)
         {
            this.setTagError(this.var_807,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_808,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1585)
         {
            this.setTagError(this.var_807,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_808,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1581)
         {
            this.var_982.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_785.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_808.clearErrors();
         this.var_982.clearErrors();
         this.var_1210.clearErrors();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_450,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_881,this.onDoorModePasswordUnselect);
         ...
         this.var_785 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1206 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_807 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_808 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_982 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1210 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1204 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1205 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1208 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_639 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1919 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1468 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1207 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         ...
         this.var_1467 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_267 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1203 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2709 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2710 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1922 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1922.procedure = this.onSwitchView;
         this.var_1203.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2710.visible = this.var_524;
         this.var_2709.visible = !this.var_524;
         if(this.var_524)
         {
         ...
         else
         {
            ...
            this.var_1467.visible = true;
            this.var_1468.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1468.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1207.height = Util.getLowestPoint(this.var_1207) + 4;
         }
         this.var_1922.text = !!this.var_524 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1919.name,this.var_1468.name,this.var_1207.name,this.var_1211.name,this.var_1467.name,this.var_1920.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_785.setText(_loc1_.name);
         this.var_1206.setText(_loc1_.description);
         this.var_982.setText("");
         this.var_1210.setText("");
         ...
         {
            case RoomSettingsData.const_192:
         ...
         this.setTag(this.var_807,_loc1_.tags[0]);
         this.setTag(this.var_808,_loc1_.tags[1]);
         if(this.var_1204)
         {
            if(_loc1_.allowPets)
            {
         ...
         if(this.var_1205)
         {
            ...
            {
               this.var_1205.select();
            }
            else
            {
               this.var_1205.unselect();
            }
         }
         if(this.var_1208)
         {
         ...
         if(this.var_639)
         {
            ...
            {
               this.var_639.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_639.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_785.getText();
         _loc2_.description = this.var_1206.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_192;
               break;
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_114;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_420;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_114)
         {
            _loc8_ = this.var_982.getText();
            _loc9_ = this.var_1210.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_982.clearErrors();
               this.var_1210.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1205.isSelected;
         _loc2_.allowWalkThrough = this.var_1208.isSelected;
         _loc2_.hideWalls = this.var_639.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_807,_loc2_.tags);
         this.addTag(this.var_808,_loc2_.tags);
         this.clearErrors();
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_162,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_57,HabboWindowStyle.const_31,HabboWindowParam.const_62,new Rectangle(0,0,100,20)));
      }
      ...
      private function onFlatControllerClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:FlatControllerData = this.method_7(_loc4_);
         if(_loc5_ == null)
         {
      ...
      private function method_7(param1:int) : FlatControllerData
      {
         var _loc2_:* = null;
