package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailEditorModel
   {
      ...
      private var var_202:RoomThumbnailObjectData;
      ...
      private function removeSelected() : void
      {
         ...
         var _loc2_:int = Util.remove(_loc1_,this.var_202);
         this.var_202 = null;
         if(_loc1_.length > 0)
         {
            this.var_202 = _loc1_[Math.min(_loc2_,_loc1_.length - 1)];
         }
      }
      ...
      {
         this.var_202 = this.findByPos(param1);
         if(this.var_202 == null)
         {
      ...
      {
         if(this.var_641 == const_36)
         {
            this._data.bgImgId = param1;
         }
         else if(this.var_641 == const_59)
         {
            this._data.frontImgId = param1;
         }
         if(this.var_641 == const_33)
         {
            if(this.var_202 == null)
            {
               return;
            }
            this.var_202.imgId = param1;
         }
      }
      ...
      public function getImgId() : int
      {
         ...
         if(this.var_641 == const_59)
         {
            return this._data.frontImgId;
         }
         return this.var_202 == null ? -1 : int(this.var_202.imgId);
      }
      ...
      {
         this._data = param1;
         this.var_641 = const_36;
         if(this._data.objects.length > 0)
         {
            this.var_202 = this._data.objects[0];
         }
         else
         {
            this.var_202 = null;
