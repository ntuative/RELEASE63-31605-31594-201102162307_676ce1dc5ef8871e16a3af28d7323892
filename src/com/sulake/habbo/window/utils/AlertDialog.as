package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1296:String = "_alert_button_list";
      ...
      private static const const_1415:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1296) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  ...
                  {
                     this.var_271(this,new WindowEvent(WindowEvent.const_181,null,null));
                  }
                  break;
               case "header_button_close":
                  if(this.var_271 != null)
                  {
                     this.var_271(this,new WindowEvent(WindowEvent.const_868,null,null));
                  }
            }
         }
      }
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_762:
                  _loc2_ = this._window.findChildByName(const_762) as IInteractiveWindow;
                  break;
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1582;
         }
      }
