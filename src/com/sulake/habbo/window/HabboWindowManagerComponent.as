package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1220:uint = 1;
      ...
      private var var_815:IWindowRenderer;
      
      private var var_816:ISkinContainer;
      
      private var var_320:Array;
      
      private var var_1259:IEventDispatcher;
      
      private var var_1017:Boolean = false;
      
      private var var_1529:ProfilerOutput;
      
      private var var_1261:ProfilerAgentTask;
      
      private var var_1260:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_816 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_815 = new WindowRenderer(this.var_816);
         this.var_189 = new Array(const_409);
         ...
         {
            this.var_189[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_815,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_189[const_1220];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_333,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1453,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1529)
            {
               this.var_1529 = new ProfilerOutput(context,this,this.var_815);
            }
            this.var_1529.profiler = _loc3_;
            this.var_1261 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1261);
            this.var_1260 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1260);
            this.var_1017 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_189)
            {
               ...
               {
                  IDisposable(this.var_189.pop()).dispose();
               }
            }
            this.var_189 = null;
            if(this.var_320)
      ...
      {
         var _loc3_:Dictionary = this.var_320[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_320[0][param1] as XML : _loc4_;
      }
      
      public function getDefaultsByTypeAndStyle(param1:uint, param2:uint) : DefaultAttStruct
      {
         return this.var_816.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      {
         return this.var_189[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_189[param2].getDesktopWindow();
      ...
      {
         return this.var_189[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_189[param1].getDesktopWindow().getChildAt(this._windowContext.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_189[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1259.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_409 - 1;
            while(_loc2_ >= 0)
            {
               this.var_189[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1017)
         ...
         this.var_1259.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_409)
         {
            this.var_189[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1017)
         {
         ...
         this.var_1259.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1402,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1580,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1449,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_438,
            "style":WindowStyle.const_195,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
