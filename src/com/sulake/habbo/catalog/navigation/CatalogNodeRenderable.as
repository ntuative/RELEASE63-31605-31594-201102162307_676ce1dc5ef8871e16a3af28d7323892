package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1288:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1361:XML;
      
      private static var var_1362:XML;
       
      
      private var var_1735:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1735 == 4294967295)
            {
               this.var_1735 = _loc1_.color;
            }
            _loc1_.color = const_1288;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1543;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1472;
            }
         }
      }
      ...
      {
         this.var_58 = navigator.catalog.windowManager.buildFromXML(var_1362) as IItemListWindow;
         if(this.var_58 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1361) as IWindowContainer;
         }
         else
         {
