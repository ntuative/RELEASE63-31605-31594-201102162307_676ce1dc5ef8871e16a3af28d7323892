package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1961:int = 10;
      ...
      private const const_1695:uint = 4.293848814E9;
      
      private const const_1696:uint = 4.294967295E9;
      
      private const const_1960:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_83:
                  ...
                  break;
               case ProductTypeEnum.const_268:
                  _loc6_ = this._catalog.getPixelEffectIcon(_loc7_);
                  break;
               case ProductTypeEnum.const_337:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1686 = _loc1_.stuffTypes;
            this.var_719 = _loc1_.boxTypes;
            this.var_718 = _loc1_.ribbonTypes;
            this.var_1079 = this.var_1686[0];
            this.var_341 = this.var_719[0];
            this.var_343 = this.var_718[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_343 < 0)
         {
            this.var_343 = this.var_718.length - 1;
         }
         if(this.var_343 > this.var_718.length - 1)
         {
            this.var_343 = 0;
         }
         if(this.var_341 < 0)
         {
            this.var_341 = this.var_719.length - 1;
         }
         if(this.var_341 > this.var_719.length - 1)
         {
            this.var_341 = 0;
         }
         var _loc1_:int = this.var_719[this.var_341] * 1000 + this.var_718[this.var_343];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_91.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1079,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1336 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1686;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1079);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_719[this.var_341]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_718[this.var_343]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_91,this.var_1335,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_91.offerId,this.var_1335);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_105:
               ...
               if(this.var_2294 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_225)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1961)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2294 = _loc3_.text;
               break;
            case WindowMouseEvent.const_43:
               ...
               break;
            case WindowKeyboardEvent.const_352:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_242 == null || this.var_587 == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1960;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1695) : uint(this.const_1696);
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1079;
               }
            }
            _loc4_++;
         }
