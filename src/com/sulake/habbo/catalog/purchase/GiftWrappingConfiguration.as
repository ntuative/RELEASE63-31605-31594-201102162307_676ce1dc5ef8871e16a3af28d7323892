package com.sulake.habbo.catalog.purchase
{
   ...
   public class GiftWrappingConfiguration
   {
      ...
      public function GiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent)
      {
         ...
         this.var_1256 = _loc2_.isWrappingEnabled;
         this.var_1590 = _loc2_.wrappingPrice;
         this.var_1686 = _loc2_.stuffTypes;
         this.var_719 = _loc2_.boxTypes;
         this.var_718 = _loc2_.ribbonTypes;
      }
