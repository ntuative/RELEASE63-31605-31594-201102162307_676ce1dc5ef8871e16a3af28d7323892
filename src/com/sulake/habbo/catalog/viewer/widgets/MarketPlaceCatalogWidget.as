package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1681:int = 1;
      
      private const const_1682:int = 2;
      
      private const const_1949:int = 40;
      
      private const const_1950:int = 10;
      
      private var var_709:Array;
      
      private var var_1320:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_483)
         {
            this.var_483.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_483 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_709 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_709 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_709));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_582)
         {
            ...
            this.var_582 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_582)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1682,_loc2_.length);
         if(!this.var_483)
         {
            this.var_483 = new Timer(25);
            this.var_483.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1073 = 0;
         this.populateList();
         this.var_483.start();
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_582 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_582.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1681);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_709.length)
         {
            _loc4_ = this.var_709[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1320.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_60)
