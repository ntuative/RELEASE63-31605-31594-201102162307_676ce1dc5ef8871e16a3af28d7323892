package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_826.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_826 = null;
         }
         if(this.var_825 != null)
         {
            this.var_825.removeEventListener(WindowKeyboardEvent.const_178,this.windowKeyEventProcessor);
            this.var_825 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_826 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_826 != null)
         {
            this.var_826.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_825 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_825 != null)
         {
            this.var_825.addEventListener(WindowKeyboardEvent.const_178,this.windowKeyEventProcessor);
         }
         return true;
      }
