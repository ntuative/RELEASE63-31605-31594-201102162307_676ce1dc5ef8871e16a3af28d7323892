package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_559:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_632,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2170 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2173 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2172 = _loc3_.content as XML;
         }
         var _loc4_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsOrCreditsAndPixelsStub") as XmlAsset;
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_632,this.onSetParameter);
      ...
      private function attachStub(param1:String) : void
      {
         ...
         switch(param1)
         {
            case Offer.const_737:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2170) as IWindowContainer;
               break;
            case Offer.const_1178:
               _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2173) as IWindowContainer;
               break;
            case Offer.const_1199:
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _window.removeChild(this.var_839);
         ...
         this.var_1602 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1601 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1600 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_2753 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_559 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         if(this.var_559 != null)
         {
            if(this.var_1285 != null)
            {
               this.var_559.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1285);
            }
            else
            {
               this.var_559.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1285);
               this.var_559.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onPurchase);
            }
            this.var_559.disable();
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1602 != null)
         {
            ...
            this.var_1602.caption = "${catalog.purchase.price.credits}";
         }
         var _loc3_:String = this.var_91.activityPointType == Purse.const_196 ? "pixels" : "activitypoints";
      ...
      {
         this.var_2171 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         if(this.var_91 != null)
         {
            ...
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_91,page.pageId,this.var_2171);
         }
      }
   }
}
