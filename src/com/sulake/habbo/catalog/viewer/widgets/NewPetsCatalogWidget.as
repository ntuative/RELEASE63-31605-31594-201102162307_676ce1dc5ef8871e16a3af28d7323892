package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1348:int = 18;
      ...
      private var var_195:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_428 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_428 < 8)
         {
            return false;
         }
         this.updateAvailableBreeds(this.var_428);
         if(this.var_195 != null && this.var_195.length > 0)
         {
            this.var_366 = this.var_195[0];
         }
         else
         {
            this.var_366 = -1;
         }
         this._offers.add(this.var_428,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_195 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1348 && _loc2_ < this.var_195.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_428,this.var_195[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_195 != null && this.var_195.length > 0)
         {
            ...
            this.var_366 = this.var_195[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_428,this.var_366),this.getRaceLocalizationKey(this.var_428,this.var_366));
            }
         }
         return this.getRaceLocalizationKey(this.var_428,this.var_366);
      }
