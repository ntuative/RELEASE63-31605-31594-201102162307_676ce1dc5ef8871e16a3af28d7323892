package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_207:String = "floor";
      ...
      private var var_1559:String = "1.1";
      ...
      private var var_361:BitmapData = null;
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1434[this.var_425];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1435[this.var_423];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1436[this.var_424];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_951[this.var_425];
         for each(_loc1_ in this.var_183.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_422 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_422];
                  if(_loc9_ != null)
                  {
                     this.var_1561 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         for each(_loc1_ in this.var_183.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_511];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1435[this.var_423];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_952[this.var_424];
         for each(_loc1_ in this.var_183.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_512];
               if(_loc13_ != null)
               {
                  this.var_1559 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1436[this.var_424];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_206:
               ...
               if(this.var_425 < 0)
               {
                  this.var_425 = this.var_951.length - 1;
               }
               if(this.var_425 == this.var_951.length)
               {
                  this.var_425 = 0;
               }
               this.var_422 = 0;
               this.var_954 = 0;
               _loc5_ = this.var_951[this.var_425];
               for each(_loc8_ in this.var_183.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_954 = _loc8_.children().length();
                  }
               }
            ...
            case const_207:
               ...
               for each(_loc9_ in this.var_183.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_955 = _loc9_.children().length();
                  }
               }
            ...
            case const_92:
               ...
               if(this.var_424 < 0)
               {
                  this.var_424 = this.var_952.length - 1;
               }
               if(this.var_424 >= this.var_952.length)
               {
                  this.var_424 = 0;
               }
               this.var_512 = 0;
               this.var_953 = 0;
               _loc7_ = this.var_952[this.var_424];
               for each(_loc10_ in this.var_183.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_953 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1561,this.var_1559,64,this,"window_romantic_wide");
         ...
         {
            this.var_1859 = _loc2_.id;
            this.var_1860 = _loc3_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_360 != null && this.var_361 != null)
         {
            this.setRoomImage(this.var_360,this.var_361);
         }
      }
   }
}
