package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1734:Point;
      
      private var var_490:IItemGridWindow;
      
      private var var_1359:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_898 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1109 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1734 = new Point(this.var_84.x,this.var_84.y);
         this.var_490 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1359 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1733 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_898.text = _loc4_;
         this.var_1109.text = _loc5_;
         this.var_898.height = this.var_898.textHeight + 5;
         this.var_1109.y = this.var_898.y + this.var_898.height;
         this.var_1109.height = Math.max(130,this.var_1109.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_428:
                  _loc6_ = this.var_1733.clone();
                  if(this.var_490 != null)
                  {
                     this.var_490.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_490,this.var_1359,this.var_1816);
                     this.var_490.scrollV = 0;
                  }
                  break;
               case Offer.const_427:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_268:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_48,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_317,AvatarAction.const_563);
                              _loc16_.appendAction(AvatarAction.const_286,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2391)
         {
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_84 != null && true)
         {
            ...
            this.var_84.x = this.var_1734.x;
            this.var_84.y = this.var_1734.y;
            if(param3 != null)
            {
