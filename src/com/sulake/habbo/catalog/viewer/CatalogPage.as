package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected var var_1981:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1149:ICatalogViewer;
      ...
      private var var_500:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1146:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_500 = new EventDispatcher();
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1981 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1981) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1533:
               if(this.var_1146 == null)
               {
                  this.var_1146 = new ItemGridCatalogWidget(param1);
                  this.var_47.push(this.var_1146);
               }
               break;
            case CatalogWidgetEnum.const_1377:
            ...
            case CatalogWidgetEnum.const_1484:
               ...
               break;
            case CatalogWidgetEnum.const_1458:
            ...
            case CatalogWidgetEnum.const_1633:
               ...
               break;
            case CatalogWidgetEnum.const_1358:
            ...
            case CatalogWidgetEnum.const_1630:
               ...
               break;
            case CatalogWidgetEnum.const_1357:
               this.var_47.push(new SpacesCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1374:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_500.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_500 != null)
         {
            return this.var_500.dispatchEvent(param1);
         }
         return false;
      }
   }
