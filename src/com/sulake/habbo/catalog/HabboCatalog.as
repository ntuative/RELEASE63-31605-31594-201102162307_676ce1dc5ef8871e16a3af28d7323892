package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_340:ICatalogNavigator;
      
      private var var_97:Purse;
      
      private var var_87:RecyclerLogic;
      
      private var var_127:IMarketPlace;
      
      private var _mainContainer:IWindowContainer;
      
      private var var_212:PurchaseConfirmationDialog;
      
      private var var_285:ChargeConfirmationDialog;
      ...
      private var var_2259:GiftWrappingConfiguration;
      
      private var var_1070:ClubGiftController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         if(param1 is Offer)
         {
            ...
            this.var_212.showOffer(this,param1,param2,param3,_loc4_);
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_340.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      {
         return this.var_392.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_392.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_83)
         {
            _loc3_ = this.var_392.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_708.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_97.getActivityPointsForType(Purse.const_196)));
         var _loc1_:int = 0;
      ...
      {
         this.var_180.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_115,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_712)
         {
            if(!this.var_392.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         {
            this.var_180.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.CATALOGUE,this._mainContainer));
         }
         if(this._mainContainer.visible)
         {
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_284.getCurrentLayoutCode();
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_340 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_284 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_284.habboCatalog = this;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_90:
               this.var_1660 = param1.session.isPrivateRoom;
               if(this.var_87 != null)
               {
      ...
      private function createMarketPlace() : void
      {
         ...
         {
            this.var_127 = new MarketPlaceLogic(this,this._windowManager,this._roomEngine);
         }
      }
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1070 = new ClubGiftController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_340.buildCatalogIndex(_loc2_);
         if(this.var_707 && this.var_707 != "")
         {
            this.var_340.openPage(this.var_707);
            this.var_707 = "";
            this.var_870 = -1;
         }
         else if(this.var_870 > -1)
         {
            this.var_340.openPageById(this.var_870,this.var_1661);
            this.var_870 = -1;
            this.var_1661 = -1;
            this.var_707 = "";
         }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_284.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_284 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_284.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2260 && this.var_581 != null)
         {
            this.var_581.playSound(HabboSoundTypesEnum.const_1142);
         }
         this.var_2260 = false;
         if(this.var_285 != null)
         {
            this.var_285.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_68,this.var_97.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2261 && this.var_581 != null)
         {
            this.var_581.playSound(HabboSoundTypesEnum.const_983);
         }
         this.var_2261 = false;
         if(this.var_285 != null)
         {
         ...
         if(_loc2_.type == Purse.const_196)
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_101,_loc2_.amount));
         }
      }
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_101,_loc2_.points["null"]));
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1070.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         this.var_284.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function onMarketPlaceOwnOffers(param1:IMessageEvent) : void
      {
         if(this.var_127 != null)
         {
            this.var_127.onOwnOffers(param1);
         }
      }
      ...
      private function onMarketPlaceBuyResult(param1:IMessageEvent) : void
      {
         if(this.var_127 != null)
         {
            this.var_127.onBuyResult(param1);
         }
      }
      ...
      private function onMarketPlaceCancelResult(param1:IMessageEvent) : void
      {
         if(this.var_127 != null)
         {
            this.var_127.onCancelResult(param1);
         }
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2259 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_127.averagePricePeriod = _loc2_.averagePricePeriod;
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_285 == null)
         {
            this.var_285 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_285.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_708.remove(_loc2_.petType);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_708.add(_loc2_.petType,_loc3_.slice());
            this.var_284.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.petType,_loc3_.slice()));
         }
      }
