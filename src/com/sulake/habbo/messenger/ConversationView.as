package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_951 + const_1331)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1332;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_517 == null || _loc1_.id != this.var_517.id)
         {
            this.var_517 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_517.followingAllowed)
         {
            this.var_1872.enable();
         }
         else
         {
            this.var_1872.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_58.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_517.messages.length - const_951);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_517.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_517.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_867 || param3.type == Message.const_640 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_517.id;
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_129.send(new FollowFriendMessageComposer(this.var_517.id));
      }
