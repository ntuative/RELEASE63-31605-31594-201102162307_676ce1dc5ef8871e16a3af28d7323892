package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      private var var_1082:int = 30;
      
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         super();
         this.var_129 = param1;
         this.var_179 = IWindowContainer(param2.findChildByName("content"));
         this.var_881 = IWindowContainer(param2.findChildByName("conversationstab"));
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_179.findChildByName("convo_bg"));
         _loc3_.bitmap = this.var_129.getButtonImage("convo_bg");
      }
      
      public function getTabCount() : int
      {
         return Math.floor(this.var_881.width / this.var_1082);
      }
      ...
      private function refreshTabContent(param1:int, param2:Conversation) : Boolean
      {
         ...
         _loc3_.x = param1 * this.var_1082;
         _loc3_.width = this.var_1082;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_881.width % this.var_1082;
         _loc3_.width = this.var_1082 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_160 ? this.var_129.conversations.findConversation(param2.id) : this.var_129.conversations.openConversations[_loc3_ + this.var_129.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
