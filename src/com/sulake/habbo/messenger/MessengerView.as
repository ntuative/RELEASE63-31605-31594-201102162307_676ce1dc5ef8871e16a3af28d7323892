package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_886:ConversationsTabView;
      
      private var var_887:ITextFieldWindow;
      
      private var var_17:IFrameWindow;
      
      private var var_1352:ConversationView;
      ...
      public function openMessenger() : void
      {
         ...
         if(this.var_17 == null)
         {
            this.prepareContent();
            this.refresh();
            this.var_129.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_53,HabboToolbarIconEnum.MESSENGER,this.var_17));
         }
         else
         {
            this.refresh();
      ...
      public function refresh() : void
      {
         ...
         this.var_886.refresh();
         this.var_1352.refresh();
         if(this.var_129.conversations.openConversations.length < 1)
         {
            this.var_17.visible = false;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1352.addMessage(param2);
      }
      
      private function prepareContent() : void
      {
         this.var_17 = IFrameWindow(this.var_129.getXmlWindow("main_window"));
         ...
         this.var_886 = new ConversationsTabView(this.var_129,this.var_17);
         this.var_886.refresh();
         this.var_887 = ITextFieldWindow(this.var_17.findChildByName("message_input"));
         this.var_887.addEventListener(WindowKeyboardEvent.const_178,this.onMessageInput);
         this.var_1352 = new ConversationView(this.var_129,this.var_17);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_670,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_1181,true);
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         {
            _loc4_ = 120;
            _loc5_ = this.var_887.text;
            if(_loc5_.length > _loc4_)
            {
               this.var_887.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      private function sendMsg() : void
      {
         ...
         this.var_887.text = "";
         this.var_129.conversations.addMessageAndUpdateView(new Message(Message.const_867,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      
      public function getTabCount() : int
      {
         return this.var_886 == null ? 7 : int(this.var_886.getTabCount());
      }
   }
}
