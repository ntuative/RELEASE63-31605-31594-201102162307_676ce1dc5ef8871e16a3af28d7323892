package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_941:Array = [];
      
      private static var var_1846:int = 1000;
      
      private static var var_940:Array = [];
      
      private static var var_1843:int = 200;
      ...
      private var var_1845:IMessageComposer;
      ...
      private var var_1844:Dictionary;
      ...
      {
         this.var_757 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_758 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1845);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_941.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_758.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_941.length < var_1846)
         {
            ...
            param1.width = this.var_758.width;
            param1.height = this.var_758.height;
            var_941.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1844[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
