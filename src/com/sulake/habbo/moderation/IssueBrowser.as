package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1967:String = "my_issues";
      
      private const const_1966:String = "open_issues";
      
      private const const_1965:String = "picked_issues";
      
      private const const_1995:String = "closed_issues";
      ...
      private var var_1742:IIssueBrowserView;
      
      private var var_1740:IIssueBrowserView;
      
      private var var_1741:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_346 == _loc2_)
         {
            return;
         }
         if(this.var_346 != null)
         {
            this.var_346.visible = false;
         }
         this.var_346 = _loc2_;
         if(this.var_346 == null)
         {
         ...
         this.var_346.view.width = this.var_246.container.width;
         this.var_346.view.height = this.var_246.container.height;
         this.var_346.visible = true;
         this.var_346.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1967:
               ...
               {
                  this.var_1742 = new MyIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1742;
            case this.const_1966:
               if(this.var_1740 == null)
               {
                  this.var_1740 = new OpenIssuesView(this.issueManager,this,this.var_246.container);
               }
               return this.var_1740;
            case this.const_1965:
               if(this.var_1741 == null)
               {
                  this.var_1741 = new PickedIssuesView(this.issueManager,this,this.var_246.container);
               }
