package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_664:IssueMessageData = null;
      
      private var var_663:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2059 = param2.pickerUserId;
         this.var_2074 = param2.pickerUserName;
         this.var_1267 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1019 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1020;
         }
         if(this.var_664 == null || param1.timeStamp < this.var_664.timeStamp)
         {
            this.var_664 = param1;
         }
         if(this.var_663 == null || param1.priority > this.var_663.timeStamp)
         {
            this.var_663 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_663;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_664;
         if(_loc2_ == null)
         {
