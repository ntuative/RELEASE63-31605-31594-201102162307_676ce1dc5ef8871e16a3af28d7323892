package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1047:IDropMenuWindow;
      
      private var var_521:ITextFieldWindow;
      
      private var var_593:Boolean = true;
      
      private var var_938:ICheckBoxWindow;
      
      private var var_1422:ICheckBoxWindow;
      
      private var var_1423:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_33.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_372));
         Logger.log("BEGINNING TO SHOW: " + this.var_372);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1605;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1047 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1047);
         this.var_1047.procedure = this.onSelectTemplate;
         this.var_938 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1422 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1423 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_33,WindowTracker.const_793,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_593 || this.var_521.text == "")
         {
            this.var_33.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_938.isSelected);
         this.var_33.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1394,_loc2_,this.var_521.text,"",""));
         if(this.var_1422.isSelected || this.var_1423.isSelected || this.var_938.isSelected)
         {
            this.var_33.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1422.isSelected,this.var_1423.isSelected,this.var_938.isSelected));
         }
         this.dispose();
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_33.initMsg.roomMessageTemplates[this.var_1047.selection];
         if(_loc3_ != null)
         {
            this.var_593 = false;
