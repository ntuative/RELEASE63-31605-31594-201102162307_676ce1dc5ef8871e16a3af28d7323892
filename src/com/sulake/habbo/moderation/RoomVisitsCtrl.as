package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_850:Array = [];
      
      private static var var_1619:int = 200;
      ...
      {
         this.var_696 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1534;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_850.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_696.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_850.length < var_1619)
         {
            ...
            param1.width = this.var_696.width;
            param1.height = this.var_696.height;
            var_850.push(param1);
         }
         else
         {
