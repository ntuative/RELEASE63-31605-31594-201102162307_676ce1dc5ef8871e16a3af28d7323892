package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_895:int = 1;
      
      private const const_1670:int = 2;
      
      private const const_1671:int = 3;
      
      private const const_1668:int = 42;
      
      private const const_1669:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_462.add(FurniModel.const_44,new FurniGridView(this.var_65,FurniModel.const_44,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_462.add(FurniModel.const_47,new FurniGridView(this.var_65,FurniModel.const_47,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_462.getValue(this.var_391);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_65.getCategoryContent(this.var_391);
         if(!this.var_65.isListInited())
         {
            _loc2_ = this.const_895;
         }
         else if(!_loc1_ || _loc1_.length == 0)
         {
            _loc2_ = this.const_1670;
         }
         else
         {
            _loc2_ = this.const_1671;
         }
         if(this.var_2132 == _loc2_)
         {
            return;
         }
         this.var_2132 = _loc2_;
         ...
         switch(_loc2_)
         {
            case this.const_895:
               ...
               break;
            case this.const_1670:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               break;
            case this.const_1671:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_44,FurniModel.const_47];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_462.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_462.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_462.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_65.getGroupItemInIndex(_loc3_,this.var_391);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_786 && this.var_786.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1669)
         {
            _loc3_ = this.const_1669;
         }
         else if(_loc3_ < this.const_1668)
         {
            _loc3_ = this.const_1668;
         }
         else
         {
