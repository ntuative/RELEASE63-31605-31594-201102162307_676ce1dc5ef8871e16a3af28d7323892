package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1243:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_563 = new Timer(const_1243,1);
         this.var_563.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2185 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_563.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_563.stop();
               this.var_563 = null;
            }
            if(this.var_192 != null)
            {
               this.var_192.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_192.stop();
               this.var_192 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_841 == null)
         {
            this.var_841 = this._windowManager.buildFromXML(this.var_2185) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_841.clone() as IWindowContainer;
      ...
      public function initListImages() : void
      {
         ...
         var _loc3_:* = null;
         var _loc6_:int = 0;
         var _loc4_:Array = [const_44,const_47];
         var _loc5_:int = 0;
      ...
      public function method_2(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            if(this.var_192 != null)
            ...
            this.var_192 = new Timer(param1,1);
            this.var_192.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_192.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_80 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_47:
                  ...
                  break;
               case const_359:
                  this._controller.toggleInventoryPage(InventoryCategory.const_140);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_336);
      ...
      public function updateLocks() : void
      {
         ...
         var _loc7_:Array = [const_44,const_47];
         var _loc8_:int = 0;
      ...
      public function addLockTo(param1:int) : void
      {
         ...
         var _loc4_:* = null;
         var _loc7_:int = 0;
         var _loc5_:Array = [const_44,const_47];
         var _loc6_:int = 0;
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_468.add(const_44,new Array());
         this.var_468.add(const_47,new Array());
         if(this._view != null)
         {
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_283;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_349 || _loc3_.category == FurniCategory.const_347 || _loc3_.category == FurniCategory.const_361)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1289 && param1.type == RoomEngineObjectEvent.const_253)
         {
            this.var_1289 = false;
         }
      }
      ...
      {
         return this.var_468.getValue(param1);
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_468.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_468.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_758)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
