package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_471 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_327);
      }
      ...
      public function removePet(param1:int) : void
      {
         ...
         this.var_471.removeGridItem(_loc2_.window);
         if(this.var_327 == _loc2_)
         {
            this.var_327 = null;
            this.selectFirst();
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_471.addGridItem(_loc2_.window);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_327.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_60)
         {
            ...
            {
               case "tab_floor":
                  this.var_65.switchCategory(FurniModel.const_44);
                  break;
               case "tab_wall":
                  this.var_65.switchCategory(FurniModel.const_47);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_327 != null)
         {
            this.var_327.setSelected(false);
         }
         this.var_327 = param1;
         if(this.var_327 != null)
         {
            this.var_327.setSelected(true);
         }
      ...
      public function getPetImage(param1:int, param2:int, param3:String, param4:int, param5:Boolean) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc6_ = _loc8_.getCroppedImage(AvatarSetType.const_48);
               }
               _loc8_.dispose();
            }
         }
