package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1157:IRoomSession;
      ...
      private const const_1974:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_491,this.roomSessionEventHandler);
      ...
      {
         return FurniModel(this.var_49.getValue(InventoryCategory.const_80));
      }
      
      public function get tradingModel() : TradingModel
      {
         return TradingModel(this.var_49.getValue(InventorySubCategory.const_283));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_49.getValue(InventoryCategory.const_822));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_49.getValue(InventoryCategory.const_285));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_49.getValue(InventoryCategory.const_341));
      }
      ...
      {
         return PetsModel(this.var_49.getValue(InventoryCategory.const_140));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_49.getValue(InventoryCategory.const_336) as MarketplaceModel;
      }
      ...
      public function get clubLevel() : int
      {
         ...
         return HabboClubLevelEnum.const_39;
      }
      
      public function get hasRoomSession() : Boolean
      {
         return this.var_1157 != null;
      }
      ...
      {
         this.var_392 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_491,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_96:
               this.var_1157 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_491:
               this.petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_392 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this.var_180)
         {
            return;
         }
         ...
         this.var_49.add(InventoryCategory.const_336,_loc1_);
         ...
         this.var_49.add(InventoryCategory.const_80,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_392);
         this.var_49.add(InventoryCategory.const_285,_loc3_);
         ...
         this.var_49.add(InventoryCategory.const_822,_loc4_);
         var _loc5_:AchievementsModel = new AchievementsModel(this,this._windowManager,this._communication,this._assetLibrary,this._localization,this.var_392);
         this.var_49.add(InventoryCategory.const_341,_loc5_);
         ...
         this.var_49.add(InventorySubCategory.const_283,_loc6_);
         ...
         this.var_49.add(InventoryCategory.const_140,_loc8_);
         this.var_186 = true;
         if(this.var_2525)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_283:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_931.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_931.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_931.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_931.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.method_2(this.const_1974);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_872));
      }
