package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1363:uint = 9;
      
      public static const const_182:uint = 0;
      
      public static const const_186:uint = 1;
      
      public static const const_362:uint = 2;
      
      public static const const_272:uint = 3;
      
      public static const const_502:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_52.updateItemList(this.var_777);
         this.var_52.updateItemList(this.var_1455);
      ...
      public function close() : void
      {
         if(this.var_716)
         {
            if(this._state != const_182 && this._state != const_262)
            {
      ...
      {
         this.var_52.setMinimized(param1 != InventoryCategory.const_80);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_778 + " OTHER: " + this.var_1193);
         ...
         {
            case const_182:
               if(param1 == const_186 || param1 == const_262)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_52.alertPopup(TradingView.const_1044);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_777)
            {
               this.var_778 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1193 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_52.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_777)
            {
               this.var_52.alertPopup(TradingView.const_1195);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_307.length < const_1363)
         {
