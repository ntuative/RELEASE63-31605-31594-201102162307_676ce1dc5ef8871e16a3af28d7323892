package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_898:uint = 4284532064;
      
      private static const const_899:uint = 2577770;
      
      public static const const_1116:int = 0;
      
      public static const const_1195:int = 1;
      
      public static const const_1044:int = 2;
      ...
      private var var_390:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_390 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_898) : uint(const_899);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_898) : uint(const_899);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_1173)
            {
            ...
            this.var_390.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_444);
            this.var_390.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_390.hideDelayed();
         }
      }
