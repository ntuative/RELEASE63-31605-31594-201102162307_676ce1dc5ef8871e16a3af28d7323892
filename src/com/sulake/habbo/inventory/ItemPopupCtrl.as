package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_909:int = 5;
      
      private static const const_1235:int = 250;
      
      private static const const_1233:int = 100;
      
      private static const const_1234:int = 180;
      
      private static const const_1236:int = 200;
      ...
      {
         this.var_326 = new Timer(const_1235,1);
         this.var_325 = new Timer(const_1233,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this._assets = param2;
         this.var_326.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_325.addEventListener(TimerEvent.TIMER,this.onHideTimer);
         var _loc3_:BitmapDataAsset = this._assets.getAssetByName("popup_arrow_right_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_836 = _loc3_.content as BitmapData;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_326.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_326.stop();
            this.var_326 = null;
         }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1234,param3.width),Math.min(const_1236,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1592);
         switch(this.var_1592)
         {
            case const_1089:
               this.var_75.x = -1 * this.var_75.width - const_909;
               break;
            case const_444:
               this.var_75.x = this._parent.width + const_909;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1089:
               _loc2_.bitmap = this.var_836.clone();
               _loc2_.width = this.var_836.width;
               _loc2_.height = this.var_836.height;
               _loc2_.y = (this.var_75.height - this.var_836.height) / 2;
            ...
            case const_444:
               ...
               _loc2_.y = (this.var_75.height - this.var_686.height) / 2;
